...
impl<A: SsrStyle, B: SsrStyle> SsrStyle for EitherStyle<A, B> {
    ...
    fn into_ssr_declaration_list(this: Self) -> Self::IntoSsrDeclarationList {
        match this {
            EitherStyle::A(this) => EitherSsrDeclarationList::A(A::into_ssr_declaration_list(this)),
            EitherStyle::B(this) => EitherSsrDeclarationList::B(B::into_ssr_declaration_list(this)),
        }
    }
}
