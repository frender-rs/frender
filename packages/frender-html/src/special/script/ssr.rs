use frender_dom::{
    script::SsrScriptContent,
    ssr::{IntoSpaceAndHtmlAttributesOrEmpty, SsrComponent},
};

use crate::html::components::script;

impl<Children: SsrScriptContent> SsrComponent<Children> for script::Marker {
    ...
    fn ssr_component<Attrs: IntoSpaceAndHtmlAttributesOrEmpty>(self, attrs: Attrs, children: Children) -> Self::OneElement<Attrs> {
        Self::OneElement::<Attrs>::new(attrs.into_space_and_html_attributes_or_empty(), Children::into_script_content(children))
    }
}
