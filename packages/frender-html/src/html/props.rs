...
pub mod ElementWithMaxMinLengthAttributes {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct max_length<V: frender_attr_value::AttrValue<i32>>(pub V);
    impl<V: frender_attr_value::AttrValue<i32>> Property for max_length<V> {
        type PropertyMarker = _prop_markers::max_length;
    }
    pub struct min_length<V: frender_attr_value::AttrValue<i32>>(pub V);
    impl<V: frender_attr_value::AttrValue<i32>> Property for min_length<V> {
...
pub mod ElementWithHeightWidthU32Attributes {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct height<V: frender_attr_value::AttrValue<u32>>(pub V);
    impl<V: frender_attr_value::AttrValue<u32>> Property for height<V> {
        type PropertyMarker = _prop_markers::height;
    }
    pub struct width<V: frender_attr_value::AttrValue<u32>>(pub V);
    impl<V: frender_attr_value::AttrValue<u32>> Property for width<V> {
        type PropertyMarker = _prop_markers::width;
    }
}
pub mod ElementWithMaxF64Attribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct max<V: frender_attr_value::AttrValue<f64>>(pub V);
    impl<V: frender_attr_value::AttrValue<f64>> Property for max<V> {
...
pub mod ElementWithValueF64Attribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct value<V: frender_attr_value::AttrValue<f64>>(pub V);
    impl<V: frender_attr_value::AttrValue<f64>> Property for value<V> {
...
pub mod ElementWithOpenAttribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct open<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for open<V> {
...
pub mod ElementWithDisabledAttribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct disabled<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for disabled<V> {
...
pub mod ElementWithMultipleAttribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct multiple<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for multiple<V> {
...
pub mod ElementWithRequiredAttribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct required<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for required<V> {
...
pub mod ElementWithSizeU32Attribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct size<V: frender_attr_value::AttrValue<u32>>(pub V);
    impl<V: frender_attr_value::AttrValue<u32>> Property for size<V> {
...
pub mod ElementWithReadOnlyAttribute {
    ...
    pub use super::Element::*;
    use crate::intrinsic::Property;
    pub struct read_only<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for read_only<V> {
...
pub mod HtmlElement {
    ...
    impl<V: frender_attr_value::AttrValue<bool>> Property for hidden<V> {
        type PropertyMarker = _prop_markers::hidden;
    }
    pub struct inert<V: frender_attr_value::AttrValue<bool>>(pub V);
    ...
    pub struct tab_index<V: frender_attr_value::AttrValue<i32>>(pub V);
...
pub mod HtmlMediaElement {
    ...
    pub use super::HtmlElement::*;
    use crate::intrinsic::Property;
    pub struct auto_play<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for auto_play<V> {
        type PropertyMarker = _prop_markers::auto_play;
    }
    pub struct controls<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for controls<V> {
        type PropertyMarker = _prop_markers::controls;
    }
    pub struct r#loop<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for r#loop<V> {
        type PropertyMarker = _prop_markers::r#loop;
    }
    pub struct muted<V: frender_attr_value::AttrValue<bool>>(pub V);
...
pub mod HtmlIFrameElement {
    ...
    impl<V: frender_attr_value::AttrValue<bool>> Property for allow_fullscreen<V> {
        type PropertyMarker = _prop_markers::allow_fullscreen;
    }
    pub struct allow_payment_request<V: frender_attr_value::AttrValue<bool>>(pub V);
...
pub mod HtmlImageElement {
    ...
    impl<V: frender_attr_value::AttrValue<bool>> Property for is_map<V> {
...
pub mod HtmlLiElement {
    ...
    pub use super::HtmlElement::*;
    use crate::intrinsic::Property;
    pub struct value<V: frender_attr_value::AttrValue<i32>>(pub V);
    impl<V: frender_attr_value::AttrValue<i32>> Property for value<V> {
        type PropertyMarker = _prop_markers::value;
    }
}
...
pub mod HtmlMeterElement {
    ...
    pub use super::HtmlElement::*;
    use crate::intrinsic::Property;
    pub struct min<V: frender_attr_value::AttrValue<f64>>(pub V);
    impl<V: frender_attr_value::AttrValue<f64>> Property for min<V> {
        type PropertyMarker = _prop_markers::min;
    }
    pub struct low<V: frender_attr_value::AttrValue<f64>>(pub V);
    impl<V: frender_attr_value::AttrValue<f64>> Property for low<V> {
        type PropertyMarker = _prop_markers::low;
    }
    pub struct high<V: frender_attr_value::AttrValue<f64>>(pub V);
    impl<V: frender_attr_value::AttrValue<f64>> Property for high<V> {
        type PropertyMarker = _prop_markers::high;
    }
    pub struct optimum<V: frender_attr_value::AttrValue<f64>>(pub V);
    impl<V: frender_attr_value::AttrValue<f64>> Property for optimum<V> {
...
pub mod HtmlOListElement {
    ...
    pub use super::HtmlElement::*;
    use crate::intrinsic::Property;
    pub struct reversed<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for reversed<V> {
        type PropertyMarker = _prop_markers::reversed;
    }
    pub struct start<V: frender_attr_value::AttrValue<i32>>(pub V);
    impl<V: frender_attr_value::AttrValue<i32>> Property for start<V> {
...
pub mod HtmlOptionElement {
    ...
    pub use super::HtmlElement::*;
    use crate::intrinsic::Property;
    pub struct selected<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for selected<V> {
...
pub mod HtmlScriptElement {
    ...
    impl<V: frender_attr_value::AttrValue<bool>> Property for r#async<V> {
        type PropertyMarker = _prop_markers::r#async;
    }
    pub struct defer<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for defer<V> {
        type PropertyMarker = _prop_markers::defer;
    }
    pub struct no_module<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for no_module<V> {
...
pub mod HtmlTableColElement {
    ...
    pub use super::HtmlTableChildElement::*;
    use crate::intrinsic::Property;
    pub struct span<V: frender_attr_value::AttrValue<u32>>(pub V);
...
pub mod HtmlTableCellElement {
    ...
    pub use super::HtmlTableChildElement::*;
    use crate::intrinsic::Property;
    pub struct col_span<V: frender_attr_value::AttrValue<u32>>(pub V);
...
pub mod HtmlTextAreaElement {
    ...
    pub struct cols<V: frender_attr_value::AttrValue<u32>>(pub V);
    impl<V: frender_attr_value::AttrValue<u32>> Property for cols<V> {
        type PropertyMarker = _prop_markers::cols;
    }
    pub struct rows<V: frender_attr_value::AttrValue<u32>>(pub V);
...
pub mod HtmlTrackElement {
    ...
    pub use super::HtmlElement::*;
    use crate::intrinsic::Property;
    pub struct default<V: frender_attr_value::AttrValue<bool>>(pub V);
...
pub mod HtmlUListElement {
    ...
    pub use super::HtmlElement::*;
    use crate::intrinsic::Property;
    pub struct compact<V: frender_attr_value::AttrValue<bool>>(pub V);
    impl<V: frender_attr_value::AttrValue<bool>> Property for compact<V> {
...
pub mod HtmlVideoElement {
    ...
    pub use super::HtmlMediaElement::*;
    use crate::intrinsic::Property;
    pub struct plays_inline<V: frender_attr_value::AttrValue<bool>>(pub V);
