...
mod struct_data {
    ...
    pub struct blockquote<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlQuoteElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlQuoteElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlQuoteElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlQuoteElement,
            <HtmlQuoteElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlQuoteElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for blockquote::Data<TypeDefs, ComponentType>
    where
        HtmlQuoteElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlQuoteElementProps::Data<
                TypeDefs,
