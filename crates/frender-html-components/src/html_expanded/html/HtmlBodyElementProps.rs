...
mod trait_types {
    ...
    pub trait Types {
        ...
        type alink: crate::imports::MaybeUpdateValueWithState<str>;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn alink<V: crate::imports::MaybeUpdateValueWithState<str>>(
            self,
            alink: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::props::UpdateElement<web_sys::HtmlBodyElement> for super::Data<TypeDefs>
    where
            ...
            crate::imports::props::UpdateElement<web_sys::HtmlElement>,
    {
        type State = super::render_state::RenderState<
            dyn super::render_state::RenderStateTypes<
                ...
                alink = <TypeDefs::alink as ::frender_dom::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
            >,
        >;
        ...
        fn update_element(
            ...
            <TypeDefs::alink as ::frender_dom::props::MaybeUpdateValueWithState<
                str,
