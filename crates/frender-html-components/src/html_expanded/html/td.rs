...
mod impl_update_render_state_dom {
    ...
    impl<
        ...
        for td::Data<TypeDefs, ComponentType>
    where
        HtmlTableCellElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlTableCellElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlTableCellElement,
            <HtmlTableCellElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlTableCellElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for td::Data<TypeDefs, ComponentType>
    where
        HtmlTableCellElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlTableCellElementProps::Data<
                TypeDefs,
