...
mod trait_types {
    ...
    pub trait Types {
        ...
        type data: crate::imports::MaybeUpdateValueWithState<str>;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn data<V: crate::imports::MaybeUpdateValueWithState<str>>(
            self,
            data: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::props::UpdateElement<web_sys::HtmlObjectElement> for super::Data<TypeDefs>
    where
