...
mod impl_update_render_state_dom {
    ...
    where
        HtmlScriptElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlScriptElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlScriptElement,
            <HtmlScriptElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlScriptElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for script::Data<TypeDefs, ComponentType>
    where
        HtmlScriptElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlScriptElementProps::Data<
                TypeDefs,
