...
mod impl_update_render_state_dom {
    ...
    where
        HtmlProgressElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlProgressElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlProgressElement,
            <HtmlProgressElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlProgressElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for progress::Data<TypeDefs, ComponentType>
    where
        HtmlProgressElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlProgressElementProps::Data<
                TypeDefs,
