...
mod trait_types {
    ...
    pub trait Types {
        ...
        type value: crate::imports::MaybeUpdateValueWithState<i32>;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn value<V: crate::imports::MaybeUpdateValueWithState<i32>>(
            self,
            value: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::props::UpdateElement<web_sys::HtmlLiElement> for super::Data<TypeDefs>
    where
