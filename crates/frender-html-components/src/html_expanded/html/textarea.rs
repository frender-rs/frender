...
mod impl_update_render_state_dom {
    ...
    where
        HtmlTextAreaElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlTextAreaElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlTextAreaElement,
            <HtmlTextAreaElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlTextAreaElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for textarea::Data<TypeDefs, ComponentType>
    where
        HtmlTextAreaElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlTextAreaElementProps::Data<
                TypeDefs,
