...
mod struct_data {
    ...
    pub struct del<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlModElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlModElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlModElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlModElement,
            <HtmlModElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlModElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for del::Data<TypeDefs, ComponentType>
    where
        HtmlModElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlModElementProps::Data<
                TypeDefs,
