...
mod impl_update_render_state_dom {
    ...
    where
        HtmlFieldSetElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlFieldSetElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlFieldSetElement,
            <HtmlFieldSetElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlFieldSetElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for fieldset::Data<TypeDefs, ComponentType>
    where
        HtmlFieldSetElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlFieldSetElementProps::Data<
                TypeDefs,
