...
mod impl_update_render_state_dom {
    ...
    where
        HtmlCanvasElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlCanvasElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlCanvasElement,
            <HtmlCanvasElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlCanvasElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for canvas::Data<TypeDefs, ComponentType>
    where
        HtmlCanvasElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlCanvasElementProps::Data<
                TypeDefs,
