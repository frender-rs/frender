...
mod struct_data {
    ...
    pub struct img<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlImageElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlImageElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlImageElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlImageElement,
            <HtmlImageElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlImageElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for img::Data<TypeDefs, ComponentType>
    where
        HtmlImageElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlImageElementProps::Data<
                TypeDefs,
