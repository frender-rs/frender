...
mod impl_update_render_state_dom {
    ...
    where
        HtmlSelectElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlSelectElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlSelectElement,
            <HtmlSelectElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlSelectElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for select::Data<TypeDefs, ComponentType>
    where
        HtmlSelectElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlSelectElementProps::Data<
                TypeDefs,
