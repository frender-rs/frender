...
mod impl_update_render_state_dom {
    ...
    where
        HtmlIFrameElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlIFrameElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlIFrameElement,
            <HtmlIFrameElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlIFrameElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for iframe::Data<TypeDefs, ComponentType>
    where
        HtmlIFrameElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlIFrameElementProps::Data<
                TypeDefs,
