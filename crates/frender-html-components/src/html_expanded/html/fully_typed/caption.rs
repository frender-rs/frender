...
mod impl_update_render_state_dom {
    ...
    where
        HtmlTableCaptionElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlTableCaptionElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlTableCaptionElement,
            <HtmlTableCaptionElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlTableCaptionElement,
            >>::State,
        >;
        ...
        fn update_render_state(
            ...
            node_and_mounted.update(ctx, |element, children_ctx| {
                <HtmlTableCaptionElementProps::Data<
                            TypeDefs,
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for caption::Data<TypeDefs, ComponentType>
    where
        HtmlTableCaptionElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
