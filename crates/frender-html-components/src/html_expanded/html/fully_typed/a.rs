...
mod impl_update_render_state_dom {
    ...
    where
        HtmlAnchorElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlAnchorElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlAnchorElement,
            <HtmlAnchorElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlAnchorElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for a::Data<TypeDefs, ComponentType>
    where
        HtmlAnchorElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlAnchorElementProps::Data<
                TypeDefs,
