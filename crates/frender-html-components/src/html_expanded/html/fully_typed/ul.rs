...
mod struct_data {
    ...
    pub struct ul<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlUListElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlUListElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlUListElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlUListElement,
            <HtmlUListElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlUListElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for ul::Data<TypeDefs, ComponentType>
    where
        HtmlUListElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlUListElementProps::Data<
                TypeDefs,
