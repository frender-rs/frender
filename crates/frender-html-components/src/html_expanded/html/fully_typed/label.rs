...
mod struct_data {
    ...
    pub struct label<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlLabelElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlLabelElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlLabelElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlLabelElement,
            <HtmlLabelElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlLabelElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for label::Data<TypeDefs, ComponentType>
    where
        HtmlLabelElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlLabelElementProps::Data<
                TypeDefs,
