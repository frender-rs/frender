...
mod struct_data {
    ...
    pub struct body<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlBodyElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlBodyElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlBodyElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlBodyElement,
            <HtmlBodyElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlBodyElement,
            >>::State,
        >;
