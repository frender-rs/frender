...
mod struct_data {
    ...
    pub struct li<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlLiElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlLiElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlLiElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlLiElement,
            <HtmlLiElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlLiElement,
            >>::State,
        >;
