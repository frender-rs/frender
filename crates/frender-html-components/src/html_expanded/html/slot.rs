...
mod struct_data {
    ...
    pub struct slot<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlSlotElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlSlotElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlSlotElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlSlotElement,
            <HtmlSlotElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlSlotElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for slot::Data<TypeDefs, ComponentType>
    where
        HtmlSlotElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlSlotElementProps::Data<
                TypeDefs,
