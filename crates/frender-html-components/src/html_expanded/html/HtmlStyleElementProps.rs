...
pub mod data_struct {
    #[non_exhaustive]
    pub struct HtmlStyleElementProps<TypeDefs: super::Types + ?::core::marker::Sized> {
...
pub use data_struct::HtmlStyleElementProps as Building;
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::props::UpdateElement<web_sys::HtmlStyleElement> for super::Data<TypeDefs>
    where
