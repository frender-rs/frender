...
mod struct_data {
    ...
    pub struct br<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlBrElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlBrElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlBrElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlBrElement,
            <HtmlBrElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlBrElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for br::Data<TypeDefs, ComponentType>
    where
        HtmlBrElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlBrElementProps::Data<
                TypeDefs,
            ...
            >>::State,
            <HtmlBrElementProps::Data<TypeDefs> as ::frender_ssr::IntoSsrData<W>>::Attrs,
            W,
        >;
