...
mod struct_data {
    ...
    pub struct time<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlTimeElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    where
        HtmlTimeElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlTimeElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlTimeElement,
            <HtmlTimeElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlTimeElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for time::Data<TypeDefs, ComponentType>
    where
        HtmlTimeElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlTimeElementProps::Data<
                TypeDefs,
