...
mod trait_types {
    ...
    pub trait Types {
        ...
        type label: crate::imports::MaybeUpdateValueWithState<str>;
        type selected: crate::imports::MaybeUpdateValueWithState<bool>;
...
pub use data_struct::HtmlOptionElementProps as Building;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn label<V: crate::imports::MaybeUpdateValueWithState<str>>(
            self,
            label: V,
        ...
        #[inline(always)]
        pub fn selected<V: crate::imports::MaybeUpdateValueWithState<bool>>(
            self,
            selected: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::props::UpdateElement<web_sys::HtmlOptionElement> for super::Data<TypeDefs>
    where
            ...
            crate::imports::props::UpdateElement<web_sys::HtmlElement>,
    {
        type State = super::render_state::RenderState<
            dyn super::render_state::RenderStateTypes<
                ...
                label = <TypeDefs::label as ::frender_dom::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
                selected = <TypeDefs::selected as ::frender_dom::props::MaybeUpdateValueWithState<
                    bool,
                >>::State,
        ...
        fn update_element(
            ...
            <TypeDefs::selected as ::frender_dom::props::MaybeUpdateValueWithState<
                bool,
            >>::maybe_update_value_with_state(
                this.selected,
                state.selected,
                    ...
                    .chain(
                        ::frender_ssr::utils::filter::FilterIdentity(
                            [
                                ...
                                <TypeDefs::selected as ::frender_dom::props::MaybeUpdateValueWithState<
                                    bool,
                                >>::maybe_into_html_attribute_value(this.selected)
                                    .map(|value| (
