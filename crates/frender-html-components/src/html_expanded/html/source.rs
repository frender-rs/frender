...
mod impl_update_render_state_dom {
    ...
    where
        HtmlSourceElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlSourceElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlSourceElement,
            <HtmlSourceElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlSourceElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for source::Data<TypeDefs, ComponentType>
    where
        HtmlSourceElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlSourceElementProps::Data<
                TypeDefs,
