...
mod struct_data {
    ...
    pub struct meta<
        ...
        ComponentType: crate::imports::frender_html::props::IntrinsicComponent
            = super::ComponentType,
    >(
        pub HtmlMetaElementProps::Data<TypeDefs>,
        pub ComponentType,
    );
}
...
mod impl_update_render_state_dom {
    ...
    impl<
        ...
        for meta::Data<TypeDefs, ComponentType>
    where
        HtmlMetaElementProps::Data<TypeDefs>:
            ::frender_dom::props::UpdateElement<web_sys::HtmlMetaElement>,
    {
        type State = ::frender_dom::element::intrinsic::IntrinsicComponentRenderState<
            web_sys::HtmlMetaElement,
            <HtmlMetaElementProps::Data<TypeDefs> as ::frender_dom::props::UpdateElement<
                web_sys::HtmlMetaElement,
            >>::State,
        >;
...
mod impl_update_render_state_ssr {
    ...
    impl<
        ...
        for meta::Data<TypeDefs, ComponentType>
    where
        HtmlMetaElementProps::Data<TypeDefs>: ::frender_ssr::IntoSsrData<W>,
    {
        type State = ::frender_ssr::element::html::HtmlElementRenderState<
            'static,
            <<HtmlMetaElementProps::Data<
                TypeDefs,
