...
mod trait_types {
    ...
    pub trait Types {
        ...
        type open: crate::imports::MaybeUpdateValueWithState<bool>;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn open<V: crate::imports::MaybeUpdateValueWithState<bool>>(
            self,
            open: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::props::UpdateElement<web_sys::HtmlDialogElement> for super::Data<TypeDefs>
    where
