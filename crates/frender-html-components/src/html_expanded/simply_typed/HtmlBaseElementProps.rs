def_props_type!(
    ...
    HtmlBaseElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], href : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], target :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],]
);
#[cfg(feature = "dom")]
