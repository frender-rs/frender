...
#[inline(always)]
pub fn HtmlBaseElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlBaseElementProps<
...
pub use building_struct::HtmlBaseElementProps as Building;
pub use data_struct::HtmlBaseElementProps as Data;
pub type DataInitial = data_struct::HtmlBaseElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlBaseElement>,
