...
#[inline(always)]
pub fn HtmlObjectElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlObjectElementProps<
...
pub use building_struct::HtmlObjectElementProps as Building;
pub use data_struct::HtmlObjectElementProps as Data;
pub type DataInitial = data_struct::HtmlObjectElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(data, form, height, name, type_, use_map, width,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
        ...
        for super::props::data<V>
    {
        type State = super::props::data<V::State>;
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn data<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            data: V,
        ) -> super::Building<Children, (Props, super::props::data<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::data(data)),
            })
        }
        #[inline(always)]
