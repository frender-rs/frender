def_props_type!(
    ...
    HtmlObjectElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], data : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], form :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
