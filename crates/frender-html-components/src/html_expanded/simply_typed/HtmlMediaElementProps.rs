...
#[inline(always)]
pub fn HtmlMediaElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlMediaElementProps<
...
pub use building_struct::HtmlMediaElementProps as Building;
pub use data_struct::HtmlMediaElementProps as Data;
pub type DataInitial = data_struct::HtmlMediaElementProps;
pub mod prelude {}
#[inline(always)]
