...
#[inline(always)]
pub fn HtmlScriptElementProps() -> Building {
...
pub use building_struct::HtmlScriptElementProps as Building;
pub use data_struct::HtmlScriptElementProps as Data;
pub type DataInitial = data_struct::HtmlScriptElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn r#async<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            r#async: V,
        ) -> super::Building<Children, (Props, super::props::r#async<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::r#async(r#async)),
            })
        }
        #[inline(always)]
        pub fn cross_origin<
        ...
        pub fn defer<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            defer: V,
        ) -> super::Building<Children, (Props, super::props::defer<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::defer(defer)),
            })
        }
        #[inline(always)]
        ...
        >(
            self,
            no_module: V,
        ) -> super::Building<Children, (Props, super::props::no_module<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::no_module(no_module)),
            })
        }
        #[inline(always)]
