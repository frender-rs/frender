def_props_type!(
    ...
    HtmlScriptElementProps(
        ...
        r#async: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<bool>],
        cross_origin: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        defer: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<bool>],
        ...
        no_module: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<bool>],
...
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::r#async(
        bounds as crate::imports::impl_bounds::MaybeValue<bool>,
        element as web_sys::HtmlScriptElement,
        attr_name = "r#async",
        csr {
            update: |el: &web_sys::HtmlScriptElement, _, &v: &_| el.set_async(v),
    ...
    crate::imports::impl_bounds!(super::props::cross_origin(
        ...
        csr {
            update: |el: &web_sys::HtmlScriptElement, _, v: &_| (|v: &_| el
                .set_cross_origin(Some(v)))(
                v
            ),
            remove: |el: &web_sys::HtmlScriptElement, _| (|| el.set_cross_origin(None))(),
        },
    ));
    crate::imports::impl_bounds!(super::props::defer(
        bounds as crate::imports::impl_bounds::MaybeValue<bool>,
        element as web_sys::HtmlScriptElement,
        attr_name = "defer",
        csr {
            update: |el: &web_sys::HtmlScriptElement, _, &v: &_| el.set_defer(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    ...
    crate::imports::impl_bounds!(super::props::integrity(
        ...
        attr_name = "integrity",
        csr {
            update: |el: &web_sys::HtmlScriptElement, _, v: &_| el.set_integrity(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::no_module(
        bounds as crate::imports::impl_bounds::MaybeValue<bool>,
        element as web_sys::HtmlScriptElement,
        attr_name = "nomodule",
        csr {
            update: |el: &web_sys::HtmlScriptElement, _, &v: &_| el.set_no_module(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    ...
    crate::imports::impl_bounds!(super::props::src(
        ...
        attr_name = "src",
        csr {
            update: |el: &web_sys::HtmlScriptElement, _, v: &_| el.set_src(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::r#type(
        ...
        attr_name = "r#type",
        csr {
            update: |el: &web_sys::HtmlScriptElement, _, v: &_| el.set_type(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
