def_props_type!(
    ...
    HtmlScriptElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], r#async : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], cross_origin :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    defer : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], fetch_priority : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], integrity :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    no_module : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], referrer_policy : bounds![crate
