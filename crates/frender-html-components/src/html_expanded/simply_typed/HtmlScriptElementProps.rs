...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::r#async(
        ...
        attr_name = "r#async",
        csr {
            update: |el: &mut ET::HtmlScriptElement<Renderer>, renderer: &mut _, _, &v: &_| el
                .set_async(renderer, v),
    ...
    crate::imports::impl_bounds!(super::props::cross_origin(
        ...
        csr {
            update: |element: &mut ET::HtmlScriptElement<Renderer>,
                     renderer: &mut Renderer,
                     _: &_,
                     value: &_| element.set_cross_origin(renderer, Some(value)),
            remove: |element: &mut ET::HtmlScriptElement<Renderer>,
                     renderer: &mut Renderer,
