def_props_type!(
    ...
    HtmlMetaElementProps(
        ...
        charset: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        content: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        http_equiv: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
...
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::charset(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlMetaElement,
        attr_name = "charset",
        csr {
    ...
    crate::imports::impl_bounds!(super::props::content(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlMetaElement,
        attr_name = "content",
        csr {
            update: |el: &web_sys::HtmlMetaElement, _, v: &_| el.set_content(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::http_equiv(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlMetaElement,
        attr_name = "http-equiv",
        csr {
            update: |el: &web_sys::HtmlMetaElement, _, v: &_| el.set_http_equiv(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::name(
        ...
        attr_name = "name",
        csr {
            update: |el: &web_sys::HtmlMetaElement, _, v: &_| el.set_name(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
