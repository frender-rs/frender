def_props_type!(
    ...
    HtmlMetaElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], charset : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], content :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    http_equiv : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState
