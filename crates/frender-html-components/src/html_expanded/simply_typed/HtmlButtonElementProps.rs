...
#[inline(always)]
pub fn HtmlButtonElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlButtonElementProps<
...
pub use building_struct::HtmlButtonElementProps as Building;
pub use data_struct::HtmlButtonElementProps as Data;
pub type DataInitial = data_struct::HtmlButtonElementProps;
pub mod prelude {}
#[inline(always)]
