...
#[inline(always)]
pub fn HtmlModElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlModElementProps<
...
pub use building_struct::HtmlModElementProps as Building;
pub use data_struct::HtmlModElementProps as Data;
pub type DataInitial = data_struct::HtmlModElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(cite, date_time,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlModElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::cite<V>
    {
        type State = super::props::cite<V::State>;
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlModElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::date_time<V>
    {
        type State = super::props::date_time<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn cite<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            cite: V,
        ) -> super::Building<Children, (Props, super::props::cite<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::cite(cite)),
            })
        }
        #[inline(always)]
        pub fn date_time<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            date_time: V,
        ) -> super::Building<Children, (Props, super::props::date_time<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::date_time(date_time)),
            })
        }
    }
}
