def_props_type!(
    ...
    HtmlModElementProps[..HtmlElementProps[..ElementProps[children, class : bounds![crate
    ...
    on_drop,], cite : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], date_time :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],]
);
#[cfg(feature = "dom")]
