...
#[inline(always)]
pub fn HtmlMapElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlMapElementProps<
...
pub use building_struct::HtmlMapElementProps as Building;
pub use data_struct::HtmlMapElementProps as Data;
pub type DataInitial = data_struct::HtmlMapElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlMapElement>,
