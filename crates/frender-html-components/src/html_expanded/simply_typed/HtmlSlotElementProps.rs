...
#[inline(always)]
pub fn HtmlSlotElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlSlotElementProps<
...
pub use building_struct::HtmlSlotElementProps as Building;
pub use data_struct::HtmlSlotElementProps as Data;
pub type DataInitial = data_struct::HtmlSlotElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlSlotElement>,
