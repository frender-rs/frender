def_props_type!(
    ...
    HtmlInputElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], accept : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], alt :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    auto_complete : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], capture :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    checked : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], dirname : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], disabled :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < bool >],
    form : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str
    >], form_action : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], form_enc_type :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    form_method : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState
    < str >], form_no_validate : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], form_target :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    height : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    u32 >], list : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], max :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    max_length : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState
    < i32 >], min : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], min_length :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < i32 >],
    multiple : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], name : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], pattern :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    placeholder : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState
    < str >], read_only : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], required :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < bool >],
    size : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < u32
    >], src : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], step : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], type_ :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    value : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str
    >], width : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    u32 >],]
);
#[cfg(feature = "dom")]
