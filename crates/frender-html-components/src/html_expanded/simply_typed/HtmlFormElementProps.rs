...
#[inline(always)]
pub fn HtmlFormElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlFormElementProps<
...
pub use building_struct::HtmlFormElementProps as Building;
pub use data_struct::HtmlFormElementProps as Data;
pub type DataInitial = data_struct::HtmlFormElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        >(
            self,
            accept_charset: V,
        ) -> super::Building<Children, (Props, super::props::accept_charset<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::accept_charset(accept_charset)),
            })
        }
        #[inline(always)]
        ...
        pub fn action<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            action: V,
        ) -> super::Building<Children, (Props, super::props::action<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::action(action)),
            })
        }
        #[inline(always)]
        pub fn enc_type<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            enc_type: V,
        ) -> super::Building<Children, (Props, super::props::enc_type<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::enc_type(enc_type)),
            })
        }
        #[inline(always)]
        pub fn method<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            method: V,
        ) -> super::Building<Children, (Props, super::props::method<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::method(method)),
            })
        }
        #[inline(always)]
        pub fn no_validate<
        ...
        >(
            self,
            no_validate: V,
        ) -> super::Building<Children, (Props, super::props::no_validate<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::no_validate(no_validate)),
            })
        }
        #[inline(always)]
        pub fn target<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            target: V,
        ) -> super::Building<Children, (Props, super::props::target<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::target(target)),
            })
        }
        #[inline(always)]
        pub fn on_form_data<V>(
            self,
            on_form_data: V,
        ) -> super::Building<Children, (Props, super::props::on_form_data<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::on_form_data(on_form_data)),
            })
        }
        #[inline(always)]
        pub fn on_reset<V>(
            self,
            on_reset: V,
        ) -> super::Building<Children, (Props, super::props::on_reset<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::on_reset(on_reset)),
            })
        }
        #[inline(always)]
        pub fn on_submit<V>(
            self,
            on_submit: V,
        ) -> super::Building<Children, (Props, super::props::on_submit<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::on_submit(on_submit)),
            })
        }
    }
}
