def_props_type!(
    ...
    ::imports::frender_html::html::event_type_helpers::on_transition_cancel)]
        ...
        on_form_data:
            bounds![
                #[event(crate::imports::frender_html::html::event_type_helpers::on_form_data)]
                crate::imports::impl_bounds::MaybeHandleEvent::Bounds
            ],
        on_reset:
            bounds![
                #[event(crate::imports::frender_html::html::event_type_helpers::on_reset)]
                crate::imports::impl_bounds::MaybeHandleEvent::Bounds
            ],
        on_submit:
            bounds![
                #[event(crate::imports::frender_html::html::event_type_helpers::on_submit)]
                crate::imports::impl_bounds::MaybeHandleEvent::Bounds
            ],
    )
);
