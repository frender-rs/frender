def_props_type!(
    ...
    HtmlFormElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], accept_charset :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    auto_complete : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], name :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >], rel
    : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    action : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], enc_type : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], method :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    no_validate : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState
    < bool >], target : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], on_form_data,
    on_reset, on_submit,]
);
#[cfg(feature = "dom")]
