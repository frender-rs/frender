def_props_type!(
    ...
    HtmlSourceElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], type_ : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], src :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    srcset : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], sizes : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], media :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    height : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    u32 >], width : bounds![crate
