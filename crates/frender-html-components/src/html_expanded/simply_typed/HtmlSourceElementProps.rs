...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::r#type(
        ...
        element as web_sys::HtmlSourceElement,
        attr_name = "r#type",
        csr {
            update: |el: &web_sys::HtmlSourceElement, _, v: &_| el.set_type(v),
    ...
    crate::imports::impl_bounds!(super::props::src(
        ...
        attr_name = "src",
        csr {
            update: |el: &web_sys::HtmlSourceElement, _, v: &_| el.set_src(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::srcset(
        ...
        attr_name = "srcset",
        csr {
            update: |el: &web_sys::HtmlSourceElement, _, v: &_| el.set_srcset(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::sizes(
        ...
        attr_name = "sizes",
        csr {
            update: |el: &web_sys::HtmlSourceElement, _, v: &_| el.set_sizes(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::media(
        ...
        attr_name = "media",
        csr {
            update: |el: &web_sys::HtmlSourceElement, _, v: &_| el.set_media(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
