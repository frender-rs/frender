...
#[inline(always)]
pub fn HtmlSourceElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlSourceElementProps<
...
pub use building_struct::HtmlSourceElementProps as Building;
pub use data_struct::HtmlSourceElementProps as Data;
pub type DataInitial = data_struct::HtmlSourceElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(type_, src, srcset, sizes, media, height, width,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlSourceElement>,
