def_props_type!(
    ...
    HtmlTableCellElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    >], char_off : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], v_align :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    col_span : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    u32 >], headers : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], row_span :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < u32 >],
    abbr : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str
    >], axis : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], height : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], scope :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
