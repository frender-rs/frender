...
#[inline(always)]
pub fn HtmlTableCellElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTableCellElementProps<
...
pub use building_struct::HtmlTableCellElementProps as Building;
pub use data_struct::HtmlTableCellElementProps as Data;
pub type DataInitial = data_struct::HtmlTableCellElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(
        align, bg_color, char, char_off, v_align, col_span, headers, row_span, abbr, axis, height,
        scope, width,
    );
}
#[cfg(feature = "dom")]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn char<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            char: V,
        ) -> super::Building<Children, (Props, super::props::char<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::char(char)),
            })
        }
        #[inline(always)]
        pub fn char_off<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            char_off: V,
        ) -> super::Building<Children, (Props, super::props::char_off<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::char_off(char_off)),
            })
        }
        #[inline(always)]
        pub fn v_align<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            v_align: V,
        ) -> super::Building<Children, (Props, super::props::v_align<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::v_align(v_align)),
            })
        }
        #[inline(always)]
        pub fn col_span<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<u32>>(
            self,
            col_span: V,
        ) -> super::Building<Children, (Props, super::props::col_span<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::col_span(col_span)),
            })
        }
        #[inline(always)]
        pub fn headers<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            headers: V,
        ) -> super::Building<Children, (Props, super::props::headers<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::headers(headers)),
            })
        }
        #[inline(always)]
        pub fn row_span<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<u32>>(
            self,
            row_span: V,
        ) -> super::Building<Children, (Props, super::props::row_span<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::row_span(row_span)),
            })
        }
        #[inline(always)]
        pub fn abbr<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            abbr: V,
        ) -> super::Building<Children, (Props, super::props::abbr<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::abbr(abbr)),
            })
        }
        #[inline(always)]
        pub fn axis<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            axis: V,
        ) -> super::Building<Children, (Props, super::props::axis<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::axis(axis)),
            })
        }
        #[inline(always)]
        ...
        pub fn scope<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            scope: V,
        ) -> super::Building<Children, (Props, super::props::scope<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::scope(scope)),
            })
        }
        #[inline(always)]
