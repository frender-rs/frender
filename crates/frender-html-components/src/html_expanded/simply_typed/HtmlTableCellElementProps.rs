def_props_type!(
    ...
    HtmlTableCellElementProps(
        ...
        char: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        char_off: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        v_align: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        col_span: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<u32>],
        headers: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        row_span: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<u32>],
        abbr: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        axis: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        height: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        scope: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::align(
        ...
        element as web_sys::HtmlTableCellElement,
        attr_name = "align",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_align(v),
    ...
    crate::imports::impl_bounds!(super::props::char(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "char",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_ch(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::char_off(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "charoff",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_ch_off(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::v_align(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "valign",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_v_align(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::col_span(
        bounds as crate::imports::impl_bounds::MaybeValue<u32>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "colspan",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, &v: &_| el.set_col_span(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::headers(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "headers",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_headers(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::row_span(
        bounds as crate::imports::impl_bounds::MaybeValue<u32>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "rowspan",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, &v: &_| el.set_row_span(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::abbr(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "abbr",
        csr {
    ...
    crate::imports::impl_bounds!(super::props::axis(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "axis",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_axis(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::height(
        ...
        attr_name = "height",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_height(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::scope(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTableCellElement,
        attr_name = "scope",
        csr {
    ...
    crate::imports::impl_bounds!(super::props::width(
        ...
        attr_name = "width",
        csr {
            update: |el: &web_sys::HtmlTableCellElement, _, v: &_| el.set_width(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
