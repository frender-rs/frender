def_props_type!(
    ...
    ::imports::frender_html::event_types::type_of_event::on_transition_start)]
        ...
        r#for: alias![html_for] + bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
...
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::r#for(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as HtmlOutputElement,
        attr_name = "for",
        csr {
    ...
    crate::imports::impl_bounds!(super::props::name(
        ...
        attr_name = "name",
        csr {
            update: |el: &mut ET::HtmlOutputElement<Renderer>, renderer: &mut _, _, v: &_| el
                .set_name(renderer, v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
