...
#[inline(always)]
pub fn HtmlOutputElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlOutputElementProps<
...
pub use building_struct::HtmlOutputElementProps as Building;
pub use data_struct::HtmlOutputElementProps as Data;
pub type DataInitial = data_struct::HtmlOutputElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(html_for, form, name,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlOutputElement>,
