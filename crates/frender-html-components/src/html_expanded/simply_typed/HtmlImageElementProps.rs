...
#[inline(always)]
pub fn HtmlImageElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlImageElementProps<
...
pub use building_struct::HtmlImageElementProps as Building;
pub use data_struct::HtmlImageElementProps as Data;
pub type DataInitial = data_struct::HtmlImageElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn decoding<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            decoding: V,
        ) -> super::Building<Children, (Props, super::props::decoding<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::decoding(decoding)),
            })
        }
        #[inline(always)]
        ...
        >(
            self,
            element_timing: V,
        ) -> super::Building<Children, (Props, super::props::element_timing<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::element_timing(element_timing)),
            })
        }
        #[inline(always)]
        ...
        pub fn is_map<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            is_map: V,
        ) -> super::Building<Children, (Props, super::props::is_map<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::is_map(is_map)),
            })
        }
        #[inline(always)]
        ...
        pub fn srcset<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            srcset: V,
        ) -> super::Building<Children, (Props, super::props::srcset<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::srcset(srcset)),
            })
        }
        #[inline(always)]
        ...
        pub fn use_map<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            use_map: V,
        ) -> super::Building<Children, (Props, super::props::use_map<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::use_map(use_map)),
            })
        }
    }
}
