def_props_type!(
    ...
    HtmlImageElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], alt : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], cross_origin :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    decoding : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], element_timing : bounds![crate
    ...
    is_map : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], loading : bounds![crate
    ...
    str >], srcset : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], width :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < u32 >],
    use_map : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >],]
);
#[cfg(feature = "dom")]
