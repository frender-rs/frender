...
#[inline(always)]
pub fn HtmlHtmlElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlHtmlElementProps<
...
pub use building_struct::HtmlHtmlElementProps as Building;
pub use data_struct::HtmlHtmlElementProps as Data;
pub type DataInitial = data_struct::HtmlHtmlElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn xmlns<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            xmlns: V,
        ) -> super::Building<Children, (Props, super::props::xmlns<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::xmlns(xmlns)),
            })
        }
    }
}
