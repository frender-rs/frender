def_props_type!(
    ...
    HtmlVideoElementProps[..HtmlMediaElementProps[..HtmlElementProps[..ElementProps[children,
    class : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str
    >], id : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], part : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], on_cancel,
    on_error, on_scroll, on_security_policy_violation, on_select, on_wheel, on_copy,
    on_cut, on_paste, on_composition_end, on_composition_start, on_composition_update,
    on_blur, on_focus, on_focus_in, on_focus_out, on_fullscreen_change,
    on_fullscreen_error, on_key_down, on_key_up, on_aux_click, on_click, on_context_menu,
    on_double_click, on_mouse_down, on_mouse_enter, on_mouse_leave, on_mouse_move,
    on_mouse_out, on_mouse_over, on_mouse_up, on_touch_cancel, on_touch_end,
    on_touch_move, on_touch_start,], access_key : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], auto_capitalize :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    auto_focus : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState
    < bool >], context_menu : bounds![crate
    ...
    on_drop,], auto_play : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], controls :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < bool >],
    cross_origin : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], loop_ :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < bool >],
    muted : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], preload : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], src :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    on_abort, on_can_play, on_can_play_through, on_duration_change, on_emptied, on_ended,
    on_loaded_data, on_loaded_metadata, on_load_start, on_pause, on_play, on_playing,
    on_progress, on_rate_change, on_resize, on_seeked, on_seeking, on_stalled,
    on_suspend, on_time_update, on_volume_change, on_waiting,], height : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < u32 >], plays_inline :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < bool >],
    poster : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], width : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < u32 >],]
);
#[cfg(feature = "dom")]
