...
#[inline(always)]
pub fn HtmlTableCaptionElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTableCaptionElementProps<
...
pub use building_struct::HtmlTableCaptionElementProps as Building;
pub use data_struct::HtmlTableCaptionElementProps as Data;
pub type DataInitial = data_struct::HtmlTableCaptionElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableCaptionElement>,
