def_props_type!(
    ...
    HtmlTableElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], align : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], bg_color :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    border : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], cell_padding : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], cell_spacing :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    frame : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str
    >], rules : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], summary : bounds![crate
