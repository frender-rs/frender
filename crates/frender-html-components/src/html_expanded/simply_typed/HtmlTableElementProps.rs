...
#[inline(always)]
pub fn HtmlTableElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTableElementProps<
...
pub use building_struct::HtmlTableElementProps as Building;
pub use data_struct::HtmlTableElementProps as Data;
pub type DataInitial = data_struct::HtmlTableElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableElement>,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::border<V>
    {
        type State = super::props::border<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::cell_padding<V>
    {
        type State = super::props::cell_padding<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::cell_spacing<V>
    {
        type State = super::props::cell_spacing<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::frame<V>
    {
        type State = super::props::frame<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::rules<V>
    {
        type State = super::props::rules<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::summary<V>
    {
        type State = super::props::summary<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn align<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            align: V,
        ) -> super::Building<Children, (Props, super::props::align<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::align(align)),
            })
        }
        #[inline(always)]
        pub fn bg_color<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            bg_color: V,
        ) -> super::Building<Children, (Props, super::props::bg_color<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::bg_color(bg_color)),
            })
        }
        #[inline(always)]
        pub fn border<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            border: V,
        ) -> super::Building<Children, (Props, super::props::border<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::border(border)),
            })
        }
        #[inline(always)]
        pub fn cell_padding<
        ...
        >(
            self,
            cell_padding: V,
        ) -> super::Building<Children, (Props, super::props::cell_padding<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::cell_padding(cell_padding)),
            })
        }
        #[inline(always)]
        pub fn cell_spacing<
        ...
        >(
            self,
            cell_spacing: V,
        ) -> super::Building<Children, (Props, super::props::cell_spacing<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::cell_spacing(cell_spacing)),
            })
        }
        #[inline(always)]
        pub fn frame<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            frame: V,
        ) -> super::Building<Children, (Props, super::props::frame<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::frame(frame)),
            })
        }
        #[inline(always)]
        pub fn rules<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            rules: V,
        ) -> super::Building<Children, (Props, super::props::rules<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::rules(rules)),
            })
        }
        #[inline(always)]
        pub fn summary<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            summary: V,
        ) -> super::Building<Children, (Props, super::props::summary<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::summary(summary)),
            })
        }
        #[inline(always)]
