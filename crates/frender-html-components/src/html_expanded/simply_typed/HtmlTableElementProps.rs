...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::align(
        ...
        attr_name = "align",
        csr {
            update: |el: &mut ET::HtmlTableElement<Renderer>, renderer: &mut _, _, v: &_| el
