...
#[inline(always)]
pub fn HtmlSelectElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlSelectElementProps<
...
pub use building_struct::HtmlSelectElementProps as Building;
pub use data_struct::HtmlSelectElementProps as Data;
pub type DataInitial = data_struct::HtmlSelectElementProps;
pub mod prelude {}
#[inline(always)]
