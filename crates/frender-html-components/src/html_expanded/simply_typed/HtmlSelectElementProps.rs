def_props_type!(
    ...
    HtmlSelectElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    >], multiple : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], name :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    required : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], size : bounds![crate
