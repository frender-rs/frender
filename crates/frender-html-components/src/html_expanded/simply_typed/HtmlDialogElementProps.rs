...
#[inline(always)]
pub fn HtmlDialogElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlDialogElementProps<
...
pub use building_struct::HtmlDialogElementProps as Building;
pub use data_struct::HtmlDialogElementProps as Data;
pub type DataInitial = data_struct::HtmlDialogElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlDialogElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::open<V>
    {
        type State = super::props::open<V::State>;
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn open<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            open: V,
        ) -> super::Building<Children, (Props, super::props::open<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::open(open)),
            })
        }
    }
}
