def_props_type!(
    ...
    HtmlOListElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], reversed : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], start :
