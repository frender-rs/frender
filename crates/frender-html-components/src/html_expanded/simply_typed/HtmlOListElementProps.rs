...
#[inline(always)]
pub fn HtmlOListElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlOListElementProps<
...
pub use building_struct::HtmlOListElementProps as Building;
pub use data_struct::HtmlOListElementProps as Data;
pub type DataInitial = data_struct::HtmlOListElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(reversed, start, type_,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlOListElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::reversed<V>
    {
        type State = super::props::reversed<V::State>;
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlOListElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::start<V>
    {
        type State = super::props::start<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn reversed<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            reversed: V,
        ) -> super::Building<Children, (Props, super::props::reversed<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::reversed(reversed)),
            })
        }
        #[inline(always)]
        pub fn start<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<i32>>(
            self,
            start: V,
        ) -> super::Building<Children, (Props, super::props::start<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::start(start)),
            })
        }
        #[inline(always)]
