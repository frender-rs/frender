def_props_type!(
    ...
    HtmlOListElementProps(
        ...
        reversed: bounds![crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>],
        start: bounds![crate::imports::frender_html::props::MaybeUpdateValueWithState<i32>],
        r#type: alias![type_]
            + bounds![crate::imports::frender_html::props::MaybeUpdateValueWithState<str>],
    )
);
...
mod impl_ssr_for_props {
    ...
    impl<'a, V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>
        crate::imports::frender_ssr::attrs::IntoIteratorAttrs<'a> for super::props::reversed<V>
    {
        type IntoIterAttrs =
    ...
    impl<'a, V: crate::imports::frender_html::props::MaybeUpdateValueWithState<i32>>
        crate::imports::frender_ssr::attrs::IntoIteratorAttrs<'a> for super::props::start<V>
    {
        type IntoIterAttrs =
            ::core::option::IntoIter<crate::imports::frender_ssr::element::html::HtmlAttrPair<'a>>;
        fn into_iter_attrs(this: Self) -> Self::IntoIterAttrs {
