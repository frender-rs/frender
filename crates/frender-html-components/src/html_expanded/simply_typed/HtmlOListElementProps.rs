...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::reversed(
        ...
        element as web_sys::HtmlOListElement,
        attr_name = "reversed",
        csr {
            update: |el: &web_sys::HtmlOListElement, _, &v: &_| el.set_reversed(v),
    ...
    crate::imports::impl_bounds!(super::props::start(
        ...
        attr_name = "start",
        csr {
            update: |el: &web_sys::HtmlOListElement, _, &v: &_| el.set_start(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::r#type(
        ...
        attr_name = "type",
        csr {
            update: |el: &web_sys::HtmlOListElement, _, v: &_| el.set_type(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
