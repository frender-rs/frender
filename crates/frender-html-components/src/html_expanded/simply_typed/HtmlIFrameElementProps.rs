...
#[inline(always)]
pub fn HtmlIFrameElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlIFrameElementProps<
...
pub use building_struct::HtmlIFrameElementProps as Building;
pub use data_struct::HtmlIFrameElementProps as Data;
pub type DataInitial = data_struct::HtmlIFrameElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn allow<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            allow: V,
        ) -> super::Building<Children, (Props, super::props::allow<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::allow(allow)),
            })
        }
        #[inline(always)]
        ...
        >(
            self,
            allow_fullscreen: V,
        ) -> super::Building<Children, (Props, super::props::allow_fullscreen<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::allow_fullscreen(allow_fullscreen)),
            })
        }
        #[inline(always)]
        ...
        ) -> super::Building<Children, (Props, super::props::allow_payment_request<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::allow_payment_request(allow_payment_request)),
            })
        }
        #[inline(always)]
        pub fn csp<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            csp: V,
        ) -> super::Building<Children, (Props, super::props::csp<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::csp(csp)),
            })
        }
        #[inline(always)]
        ...
        >(
            self,
            fetch_priority: V,
        ) -> super::Building<Children, (Props, super::props::fetch_priority<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::fetch_priority(fetch_priority)),
            })
        }
        #[inline(always)]
        ...
        pub fn loading<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            loading: V,
        ) -> super::Building<Children, (Props, super::props::loading<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::loading(loading)),
            })
        }
        #[inline(always)]
        ...
        >(
            self,
            referrer_policy: V,
        ) -> super::Building<Children, (Props, super::props::referrer_policy<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::referrer_policy(referrer_policy)),
            })
        }
        #[inline(always)]
        pub fn sandbox<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            sandbox: V,
        ) -> super::Building<Children, (Props, super::props::sandbox<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::sandbox(sandbox)),
            })
        }
        #[inline(always)]
        ...
        pub fn src_doc<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            src_doc: V,
        ) -> super::Building<Children, (Props, super::props::src_doc<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::src_doc(src_doc)),
            })
        }
        #[inline(always)]
