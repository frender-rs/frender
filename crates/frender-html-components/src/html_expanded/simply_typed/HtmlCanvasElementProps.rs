def_props_type!(
    ...
    HtmlCanvasElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], height : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < u32 >], width :
...
mod impl_dom_for_props {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlCanvasElement>,
