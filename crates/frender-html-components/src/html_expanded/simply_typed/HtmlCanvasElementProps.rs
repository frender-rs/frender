...
#[inline(always)]
pub fn HtmlCanvasElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlCanvasElementProps<
...
pub use building_struct::HtmlCanvasElementProps as Building;
pub use data_struct::HtmlCanvasElementProps as Data;
pub type DataInitial = data_struct::HtmlCanvasElementProps;
pub mod prelude {}
#[inline(always)]
