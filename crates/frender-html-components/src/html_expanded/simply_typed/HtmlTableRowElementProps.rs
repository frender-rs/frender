...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::align(
        ...
        element as web_sys::HtmlTableRowElement,
        attr_name = "align",
        csr {
            update: |el: &web_sys::HtmlTableRowElement, _, v: &_| el.set_align(v),
    ...
    crate::imports::impl_bounds!(super::props::char(
        ...
        attr_name = "char",
        csr {
            update: |el: &web_sys::HtmlTableRowElement, _, v: &_| el.set_ch(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::char_off(
        ...
        attr_name = "charoff",
        csr {
            update: |el: &web_sys::HtmlTableRowElement, _, v: &_| el.set_ch_off(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::v_align(
        ...
        attr_name = "valign",
        csr {
            update: |el: &web_sys::HtmlTableRowElement, _, v: &_| el.set_v_align(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
