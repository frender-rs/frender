...
#[inline(always)]
pub fn HtmlTableRowElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTableRowElementProps<
...
pub use building_struct::HtmlTableRowElementProps as Building;
pub use data_struct::HtmlTableRowElementProps as Data;
pub type DataInitial = data_struct::HtmlTableRowElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableRowElement>,
