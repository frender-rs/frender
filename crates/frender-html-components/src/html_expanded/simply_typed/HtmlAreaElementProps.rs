def_props_type!(
    ...
    HtmlAreaElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    target : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >], alt : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState
    < str >], coords : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], shape :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],]
);
#[cfg(feature = "dom")]
