def_props_type!(
    ...
    HtmlAreaElementProps(
        ...
        coords: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        shape: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
    )
);
#[cfg(feature = "csr")]
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::download(
        ...
        element as web_sys::HtmlAreaElement,
        attr_name = "download",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_download(v),
    ...
    crate::imports::impl_bounds!(super::props::href(
        ...
        attr_name = "href",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_href(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::ping(
        ...
        attr_name = "ping",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_ping(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::referrer_policy(
        ...
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_referrer_policy(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::rel(
        ...
        attr_name = "rel",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_rel(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::target(
        ...
        attr_name = "target",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_target(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::alt(
        ...
        attr_name = "alt",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_alt(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::coords(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlAreaElement,
        attr_name = "coords",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_coords(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::shape(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlAreaElement,
        attr_name = "shape",
        csr {
            update: |el: &web_sys::HtmlAreaElement, _, v: &_| el.set_shape(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
