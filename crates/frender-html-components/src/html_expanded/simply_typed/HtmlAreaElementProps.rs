...
#[inline(always)]
pub fn HtmlAreaElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlAreaElementProps<
...
pub use building_struct::HtmlAreaElementProps as Building;
pub use data_struct::HtmlAreaElementProps as Data;
pub type DataInitial = data_struct::HtmlAreaElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn download<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            download: V,
        ) -> super::Building<Children, (Props, super::props::download<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::download(download)),
            })
        }
        #[inline(always)]
        ...
        pub fn ping<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            ping: V,
        ) -> super::Building<Children, (Props, super::props::ping<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::ping(ping)),
            })
        }
        #[inline(always)]
        ...
        pub fn coords<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            coords: V,
        ) -> super::Building<Children, (Props, super::props::coords<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::coords(coords)),
            })
        }
        #[inline(always)]
        pub fn shape<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            shape: V,
        ) -> super::Building<Children, (Props, super::props::shape<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::shape(shape)),
            })
        }
    }
}
