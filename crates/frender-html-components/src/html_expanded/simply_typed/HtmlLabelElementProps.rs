...
#[inline(always)]
pub fn HtmlLabelElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlLabelElementProps<
...
pub use building_struct::HtmlLabelElementProps as Building;
pub use data_struct::HtmlLabelElementProps as Data;
pub type DataInitial = data_struct::HtmlLabelElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlLabelElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::html_for<V>
    {
        type State = super::props::html_for<V::State>;
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn html_for<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            html_for: V,
        ) -> super::Building<Children, (Props, super::props::html_for<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::html_for(html_for)),
            })
        }
    }
}
