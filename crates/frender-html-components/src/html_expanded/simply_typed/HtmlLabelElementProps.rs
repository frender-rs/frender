def_props_type!(
    ...
    HtmlLabelElementProps(
        ...
        html_for: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
    )
);
#[cfg(feature = "csr")]
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::html_for(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlLabelElement,
        attr_name = "for",
        csr {
            update: |el: &web_sys::HtmlLabelElement, _, v: &_| el.set_html_for(v),
