def_props_type!(
    ...
    HtmlLabelElementProps(
        ...
        html_for: bounds![crate::imports::frender_html::props::MaybeUpdateValueWithState<str>],
    )
);
#[cfg(feature = "dom")]
...
mod impl_ssr_for_props {
    ...
    impl<'a, V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>
        crate::imports::frender_ssr::attrs::IntoIteratorAttrs<'a> for super::props::html_for<V>
    {
        type IntoIterAttrs =
