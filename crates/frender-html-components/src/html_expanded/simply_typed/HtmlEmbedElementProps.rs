...
#[inline(always)]
pub fn HtmlEmbedElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlEmbedElementProps<
...
pub use building_struct::HtmlEmbedElementProps as Building;
pub use data_struct::HtmlEmbedElementProps as Data;
pub type DataInitial = data_struct::HtmlEmbedElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(height, src, type_, width,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
