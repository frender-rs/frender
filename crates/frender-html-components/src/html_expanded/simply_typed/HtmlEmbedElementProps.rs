...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::height(
        ...
        element as web_sys::HtmlEmbedElement,
        attr_name = "height",
        csr {
            update: |el: &web_sys::HtmlEmbedElement, _, v: &_| el.set_height(v),
    ...
    crate::imports::impl_bounds!(super::props::src(
        ...
        attr_name = "src",
        csr {
            update: |el: &web_sys::HtmlEmbedElement, _, v: &_| el.set_src(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::r#type(
        ...
        attr_name = "r#type",
        csr {
            update: |el: &web_sys::HtmlEmbedElement, _, v: &_| el.set_type(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::width(
        ...
        attr_name = "width",
        csr {
            update: |el: &web_sys::HtmlEmbedElement, _, v: &_| el.set_width(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
