...
#[inline(always)]
pub fn HtmlQuoteElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlQuoteElementProps<
...
pub use building_struct::HtmlQuoteElementProps as Building;
pub use data_struct::HtmlQuoteElementProps as Data;
pub type DataInitial = data_struct::HtmlQuoteElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlQuoteElement>,
