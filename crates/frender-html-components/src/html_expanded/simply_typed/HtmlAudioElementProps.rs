def_props_type!(
    ...
    HtmlAudioElementProps[..HtmlMediaElementProps[..HtmlElementProps[..ElementProps[children,
    ...
    on_suspend, on_time_update, on_volume_change, on_waiting,], __ : bounds![crate
