...
#[inline(always)]
pub fn HtmlAudioElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlAudioElementProps<
...
pub use building_struct::HtmlAudioElementProps as Building;
pub use data_struct::HtmlAudioElementProps as Data;
pub type DataInitial = data_struct::HtmlAudioElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn __<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            __: V,
        ) -> super::Building<Children, (Props, super::props::__<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::__(__)),
            })
        }
    }
}
