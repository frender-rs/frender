def_props_type!(
    ...
    HtmlStyleElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], media : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], blocking :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
