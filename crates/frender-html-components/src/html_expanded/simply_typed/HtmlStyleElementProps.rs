...
#[inline(always)]
pub fn HtmlStyleElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlStyleElementProps<
...
pub use building_struct::HtmlStyleElementProps as Building;
pub use data_struct::HtmlStyleElementProps as Data;
pub type DataInitial = data_struct::HtmlStyleElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(media, blocking, type_,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlStyleElement>,
