...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::disabled(
        ...
        element as web_sys::HtmlOptGroupElement,
        attr_name = "disabled",
        csr {
            update: |el: &web_sys::HtmlOptGroupElement, _, &v: &_| el.set_disabled(v),
    ...
    crate::imports::impl_bounds!(super::props::label(
        ...
        attr_name = "label",
        csr {
            update: |el: &web_sys::HtmlOptGroupElement, _, v: &_| el.set_label(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
