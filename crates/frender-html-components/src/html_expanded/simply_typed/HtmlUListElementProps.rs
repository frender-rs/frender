def_props_type!(
    ...
    HtmlUListElementProps(
        ...
        compact: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<bool>],
...
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::compact(
        bounds as crate::imports::impl_bounds::MaybeValue<bool>,
        element as web_sys::HtmlUListElement,
        attr_name = "compact",
        csr {
            update: |el: &web_sys::HtmlUListElement, _, &v: &_| el.set_compact(v),
    ...
    crate::imports::impl_bounds!(super::props::r#type(
        ...
        attr_name = "type",
        csr {
            update: |el: &web_sys::HtmlUListElement, _, v: &_| el.set_type(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
