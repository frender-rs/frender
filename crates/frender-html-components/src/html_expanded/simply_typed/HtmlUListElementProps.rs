def_props_type!(
    ...
    HtmlUListElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], compact : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], type_ :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],]
);
#[cfg(feature = "dom")]
