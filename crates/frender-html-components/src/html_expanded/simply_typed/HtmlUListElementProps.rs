...
#[inline(always)]
pub fn HtmlUListElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlUListElementProps<
...
pub use building_struct::HtmlUListElementProps as Building;
pub use data_struct::HtmlUListElementProps as Data;
pub type DataInitial = data_struct::HtmlUListElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn compact<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            compact: V,
        ) -> super::Building<Children, (Props, super::props::compact<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::compact(compact)),
            })
        }
        #[inline(always)]
