...
#[inline(always)]
pub fn HtmlAnchorElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlAnchorElementProps<
...
pub use building_struct::HtmlAnchorElementProps as Building;
pub use data_struct::HtmlAnchorElementProps as Data;
pub type DataInitial = data_struct::HtmlAnchorElementProps;
pub mod prelude {}
#[inline(always)]
