def_props_type!(
    ...
    HtmlDetailsElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], open : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >],]
);
#[cfg(feature = "dom")]
