...
#[inline(always)]
pub fn HtmlDetailsElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlDetailsElementProps<
...
pub use building_struct::HtmlDetailsElementProps as Building;
pub use data_struct::HtmlDetailsElementProps as Data;
pub type DataInitial = data_struct::HtmlDetailsElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlDetailsElement>,
