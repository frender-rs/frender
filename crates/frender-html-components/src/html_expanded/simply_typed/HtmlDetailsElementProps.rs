def_props_type!(
    ...
    HtmlDetailsElementProps(
        ...
        open: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<bool>],
    )
);
#[cfg(feature = "csr")]
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::open(
        bounds as crate::imports::impl_bounds::MaybeValue<bool>,
        element as web_sys::HtmlDetailsElement,
        attr_name = "open",
        csr {
            update: |el: &web_sys::HtmlDetailsElement, _, &v: &_| el.set_open(v),
