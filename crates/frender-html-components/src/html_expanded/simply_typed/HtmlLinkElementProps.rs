...
#[inline(always)]
pub fn HtmlLinkElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlLinkElementProps<
...
pub use building_struct::HtmlLinkElementProps as Building;
pub use data_struct::HtmlLinkElementProps as Data;
pub type DataInitial = data_struct::HtmlLinkElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn as_<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            as_: V,
        ) -> super::Building<Children, (Props, super::props::as_<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::as_(as_)),
            })
        }
        #[inline(always)]
        pub fn cross_origin<
        ...
        pub fn href<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            href: V,
        ) -> super::Building<Children, (Props, super::props::href<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::href(href)),
            })
        }
        #[inline(always)]
        pub fn href_lang<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            href_lang: V,
        ) -> super::Building<Children, (Props, super::props::href_lang<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::href_lang(href_lang)),
            })
        }
        #[inline(always)]
        pub fn image_sizes<
        ...
        >(
            self,
            image_sizes: V,
        ) -> super::Building<Children, (Props, super::props::image_sizes<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::image_sizes(image_sizes)),
            })
        }
        #[inline(always)]
        ...
        >(
            self,
            image_src_set: V,
        ) -> super::Building<Children, (Props, super::props::image_src_set<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::image_src_set(image_src_set)),
            })
        }
        #[inline(always)]
        pub fn integrity<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            integrity: V,
        ) -> super::Building<Children, (Props, super::props::integrity<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::integrity(integrity)),
            })
        }
        #[inline(always)]
        pub fn media<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            media: V,
        ) -> super::Building<Children, (Props, super::props::media<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::media(media)),
            })
        }
        #[inline(always)]
        pub fn prefetch<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            prefetch: V,
        ) -> super::Building<Children, (Props, super::props::prefetch<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::prefetch(prefetch)),
            })
        }
        #[inline(always)]
        ...
        pub fn rel<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            rel: V,
        ) -> super::Building<Children, (Props, super::props::rel<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::rel(rel)),
            })
        }
        #[inline(always)]
        pub fn sizes<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            sizes: V,
        ) -> super::Building<Children, (Props, super::props::sizes<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::sizes(sizes)),
            })
        }
        #[inline(always)]
        ...
        pub fn blocking<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            blocking: V,
        ) -> super::Building<Children, (Props, super::props::blocking<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::blocking(blocking)),
            })
        }
    }
}
