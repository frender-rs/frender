...
#[inline(always)]
pub fn HtmlTimeElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTimeElementProps<
...
pub use building_struct::HtmlTimeElementProps as Building;
pub use data_struct::HtmlTimeElementProps as Data;
pub type DataInitial = data_struct::HtmlTimeElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTimeElement>,
