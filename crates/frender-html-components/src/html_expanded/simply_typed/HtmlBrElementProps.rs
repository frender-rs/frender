def_props_type!(
    ...
    HtmlBrElementProps(
        ...
        clear: bounds![crate::imports::frender_html::props::MaybeUpdateValueWithState<str>],
    )
);
#[cfg(feature = "csr")]
...
mod impl_ssr_for_props {
    ...
    impl<'a, V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>
        crate::imports::frender_ssr::attrs::IntoIteratorAttrs<'a> for super::props::clear<V>
    {
        type IntoIterAttrs =
