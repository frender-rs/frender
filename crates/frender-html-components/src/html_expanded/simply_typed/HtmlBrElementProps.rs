def_props_type!(
    ...
    HtmlBrElementProps(
        ...
        clear: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
    )
);
#[cfg(feature = "csr")]
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::clear(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlBrElement,
        attr_name = "clear",
        csr {
            update: |el: &web_sys::HtmlBrElement, _, v: &_| el.set_clear(v),
