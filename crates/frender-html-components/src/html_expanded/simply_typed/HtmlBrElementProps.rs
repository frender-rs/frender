...
#[inline(always)]
pub fn HtmlBrElementProps() -> Building {
...
pub use building_struct::HtmlBrElementProps as Building;
pub use data_struct::HtmlBrElementProps as Data;
pub type DataInitial = data_struct::HtmlBrElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlBrElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::clear<V>
    {
        type State = super::props::clear<V::State>;
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn clear<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            clear: V,
        ) -> super::Building<Children, (Props, super::props::clear<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::clear(clear)),
            })
        }
    }
}
