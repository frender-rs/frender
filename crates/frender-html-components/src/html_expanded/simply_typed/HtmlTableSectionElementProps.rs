...
#[inline(always)]
pub fn HtmlTableSectionElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTableSectionElementProps<
...
pub use building_struct::HtmlTableSectionElementProps as Building;
pub use data_struct::HtmlTableSectionElementProps as Data;
pub type DataInitial = data_struct::HtmlTableSectionElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(align, bg_color, char, char_off, v_align,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableSectionElement>,
