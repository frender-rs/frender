...
#[inline(always)]
pub fn HtmlTableColElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTableColElementProps<
...
pub use building_struct::HtmlTableColElementProps as Building;
pub use data_struct::HtmlTableColElementProps as Data;
pub type DataInitial = data_struct::HtmlTableColElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(align, bg_color, char, char_off, v_align, span, width,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableColElement>,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTableColElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::span<V>
    {
        type State = super::props::span<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn span<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<u32>>(
            self,
            span: V,
        ) -> super::Building<Children, (Props, super::props::span<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::span(span)),
            })
        }
        #[inline(always)]
