...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::max(
        ...
        element as web_sys::HtmlProgressElement,
        attr_name = "max",
        csr {
            update: |el: &web_sys::HtmlProgressElement, _, &v: &_| el.set_max(v),
    ...
    crate::imports::impl_bounds!(super::props::value(
        ...
        attr_name = "value",
        csr {
            update: |el: &web_sys::HtmlProgressElement, _, &v: &_| el.set_value(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
