...
#[inline(always)]
pub fn HtmlProgressElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlProgressElementProps<
...
pub use building_struct::HtmlProgressElementProps as Building;
pub use data_struct::HtmlProgressElementProps as Data;
pub type DataInitial = data_struct::HtmlProgressElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlProgressElement>,
