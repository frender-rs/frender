def_props_type!(
    ...
    HtmlProgressElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], max : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < f64 >], value :
