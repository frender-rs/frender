...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::disabled(
        ...
        element as web_sys::HtmlFieldSetElement,
        attr_name = "disabled",
        csr {
            update: |el: &web_sys::HtmlFieldSetElement, _, &v: &_| el.set_disabled(v),
    ...
    crate::imports::impl_bounds!(super::props::name(
        ...
        attr_name = "name",
        csr {
            update: |el: &web_sys::HtmlFieldSetElement, _, v: &_| el.set_name(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
