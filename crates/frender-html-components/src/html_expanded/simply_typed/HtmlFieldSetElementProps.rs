...
#[inline(always)]
pub fn HtmlFieldSetElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlFieldSetElementProps<
...
pub use building_struct::HtmlFieldSetElementProps as Building;
pub use data_struct::HtmlFieldSetElementProps as Data;
pub type DataInitial = data_struct::HtmlFieldSetElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(disabled, form, name,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlFieldSetElement>,
