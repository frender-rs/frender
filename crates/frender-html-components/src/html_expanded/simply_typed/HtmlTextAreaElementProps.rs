def_props_type!(
    ...
    HtmlTextAreaElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], auto_complete : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < str >], auto_correct :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    cols : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < u32
    >], disabled : bounds![crate
    ...
    < i32 >], min_length : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < i32 >], name :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    ...
    >], wrap : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    str >],]
);
#[cfg(feature = "dom")]
