...
#[inline(always)]
pub fn HtmlTextAreaElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTextAreaElementProps<
...
pub use building_struct::HtmlTextAreaElementProps as Building;
pub use data_struct::HtmlTextAreaElementProps as Data;
pub type DataInitial = data_struct::HtmlTextAreaElementProps;
pub mod prelude {}
#[inline(always)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        >(
            self,
            auto_correct: V,
        ) -> super::Building<Children, (Props, super::props::auto_correct<V>)> {
            super::Building(super::Data {
                props: self
                    .0
                    .props
                    .chain_prop(super::props::auto_correct(auto_correct)),
            })
        }
        #[inline(always)]
        pub fn cols<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<u32>>(
            self,
            cols: V,
        ) -> super::Building<Children, (Props, super::props::cols<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::cols(cols)),
            })
        }
        #[inline(always)]
        ...
        pub fn rows<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<u32>>(
            self,
            rows: V,
        ) -> super::Building<Children, (Props, super::props::rows<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::rows(rows)),
            })
        }
        #[inline(always)]
        pub fn wrap<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            wrap: V,
        ) -> super::Building<Children, (Props, super::props::wrap<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::wrap(wrap)),
            })
        }
    }
}
