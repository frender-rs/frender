...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::auto_complete(
        ...
        element as web_sys::HtmlTextAreaElement,
        attr_name = "autocomplete",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, v: &_| el.set_autocomplete(v),
    ...
    crate::imports::impl_bounds!(super::props::cols(
        ...
        attr_name = "cols",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, &v: &_| el.set_cols(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::disabled(
        ...
        attr_name = "disabled",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, &v: &_| el.set_disabled(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    ...
    crate::imports::impl_bounds!(super::props::max_length(
        ...
        attr_name = "maxlength",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, &v: &_| el.set_max_length(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::min_length(
        ...
        attr_name = "minlength",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, &v: &_| el.set_min_length(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::name(
        ...
        attr_name = "name",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, v: &_| el.set_name(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::placeholder(
        ...
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, v: &_| el.set_placeholder(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::read_only(
        ...
        attr_name = "readonly",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, &v: &_| el.set_read_only(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::required(
        ...
        attr_name = "required",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, &v: &_| el.set_required(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::rows(
        ...
        attr_name = "rows",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, &v: &_| el.set_rows(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::wrap(
        ...
        attr_name = "wrap",
        csr {
            update: |el: &web_sys::HtmlTextAreaElement, _, v: &_| el.set_wrap(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
