def_props_type!(
    ...
    HtmlOptionElementProps(
        ...
        selected: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<bool>],
...
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::disabled(
        ...
        element as web_sys::HtmlOptionElement,
        attr_name = "disabled",
        csr {
            update: |el: &web_sys::HtmlOptionElement, _, &v: &_| el.set_disabled(v),
    ...
    crate::imports::impl_bounds!(super::props::label(
        ...
        attr_name = "label",
        csr {
            update: |el: &web_sys::HtmlOptionElement, _, v: &_| el.set_label(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::selected(
        bounds as crate::imports::impl_bounds::MaybeValue<bool>,
        element as web_sys::HtmlOptionElement,
        attr_name = "selected",
        csr {
            update: |el: &web_sys::HtmlOptionElement, _, &v: &_| el.set_selected(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::value(
        ...
        attr_name = "value",
        csr {
            update: |el: &web_sys::HtmlOptionElement, _, v: &_| el.set_value(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
