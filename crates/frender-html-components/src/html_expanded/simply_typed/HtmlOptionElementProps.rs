def_props_type!(
    ...
    HtmlOptionElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], label :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
    selected : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    bool >], value : bounds![crate
