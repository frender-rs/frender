...
#[inline(always)]
pub fn HtmlOptionElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlOptionElementProps<
...
pub use building_struct::HtmlOptionElementProps as Building;
pub use data_struct::HtmlOptionElementProps as Data;
pub type DataInitial = data_struct::HtmlOptionElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(disabled, label, selected, value,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlOptionElement>,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlOptionElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::selected<V>
    {
        type State = super::props::selected<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn selected<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            selected: V,
        ) -> super::Building<Children, (Props, super::props::selected<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::selected(selected)),
            })
        }
        #[inline(always)]
