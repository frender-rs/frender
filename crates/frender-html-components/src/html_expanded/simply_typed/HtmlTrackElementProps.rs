def_props_type!(
    ...
    HtmlTrackElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], default : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < bool >], kind :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < str >],
