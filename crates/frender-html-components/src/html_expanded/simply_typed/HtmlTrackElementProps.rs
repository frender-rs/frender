...
#[inline(always)]
pub fn HtmlTrackElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlTrackElementProps<
...
pub use building_struct::HtmlTrackElementProps as Building;
pub use data_struct::HtmlTrackElementProps as Data;
pub type DataInitial = data_struct::HtmlTrackElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(default, kind, label, src, src_lang,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTrackElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::default<V>
    {
        type State = super::props::default<V::State>;
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTrackElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::kind<V>
    {
        type State = super::props::kind<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlTrackElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::src_lang<V>
    {
        type State = super::props::src_lang<V::State>;
        fn initialize_state_non_reactive(
            this: Self,
            element: &E,
            children_ctx: &mut crate::imports::frender_dom::Dom,
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn default<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            default: V,
        ) -> super::Building<Children, (Props, super::props::default<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::default(default)),
            })
        }
        #[inline(always)]
        pub fn kind<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            kind: V,
        ) -> super::Building<Children, (Props, super::props::kind<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::kind(kind)),
            })
        }
        #[inline(always)]
        ...
        pub fn src_lang<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            src_lang: V,
        ) -> super::Building<Children, (Props, super::props::src_lang<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::src_lang(src_lang)),
            })
        }
    }
}
