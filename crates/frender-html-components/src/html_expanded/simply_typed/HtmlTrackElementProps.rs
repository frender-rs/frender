def_props_type!(
    ...
    HtmlTrackElementProps(
        ...
        default: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<bool>],
        kind: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        label: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        src: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
        src_lang: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<str>],
    )
);
#[cfg(feature = "csr")]
mod imp {
    ...
    use super::super::*;
    crate::imports::impl_bounds!(super::props::default(
        bounds as crate::imports::impl_bounds::MaybeValue<bool>,
        element as web_sys::HtmlTrackElement,
        attr_name = "default",
        csr {
            update: |el: &web_sys::HtmlTrackElement, _, &v: &_| el.set_default(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::kind(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTrackElement,
        attr_name = "kind",
        csr {
            update: |el: &web_sys::HtmlTrackElement, _, v: &_| el.set_kind(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::label(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTrackElement,
        attr_name = "label",
        csr {
            update: |el: &web_sys::HtmlTrackElement, _, v: &_| el.set_label(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::src(
        ...
        attr_name = "src",
        csr {
            update: |el: &web_sys::HtmlTrackElement, _, v: &_| el.set_src(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::src_lang(
        bounds as crate::imports::impl_bounds::MaybeValue<str>,
        element as web_sys::HtmlTrackElement,
        attr_name = "srclang",
        csr {
            update: |el: &web_sys::HtmlTrackElement, _, v: &_| el.set_srclang(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
