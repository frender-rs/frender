...
#[inline(always)]
pub fn HtmlMeterElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlMeterElementProps<
...
pub use building_struct::HtmlMeterElementProps as Building;
pub use data_struct::HtmlMeterElementProps as Data;
pub type DataInitial = data_struct::HtmlMeterElementProps;
pub mod prelude {}
#[inline(always)]
...
pub mod props {
    ...
    super::def_props!(value, min, max, low, high, optimum,);
}
#[cfg(feature = "dom")]
mod props_impl_dom {
    #[allow(unused_imports)]
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn low<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<f64>>(
            self,
            low: V,
        ) -> super::Building<Children, (Props, super::props::low<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::low(low)),
            })
        }
        #[inline(always)]
        pub fn high<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<f64>>(
            self,
            high: V,
        ) -> super::Building<Children, (Props, super::props::high<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::high(high)),
            })
        }
        #[inline(always)]
        pub fn optimum<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<f64>>(
            self,
            optimum: V,
        ) -> super::Building<Children, (Props, super::props::optimum<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::optimum(optimum)),
            })
        }
    }
}
