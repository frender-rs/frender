def_props_type!(
    ...
    HtmlMeterElementProps(
        ...
        value: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<f64>],
        min: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<f64>],
        max: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<f64>],
        low: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<f64>],
        high: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<f64>],
        optimum: bounds![crate::imports::impl_bounds::MaybeValue::Bounds<f64>],
    )
);
#[cfg(feature = "csr")]
mod imp {
    ...
    crate::imports::impl_bounds!(super::props::value(
        bounds as crate::imports::impl_bounds::MaybeValue<f64>,
        element as web_sys::HtmlMeterElement,
        attr_name = "value",
        csr {
            update: |el: &web_sys::HtmlMeterElement, _, &v: &_| el.set_value(v),
    ...
    crate::imports::impl_bounds!(super::props::min(
        ...
        attr_name = "min",
        csr {
            update: |el: &web_sys::HtmlMeterElement, _, &v: &_| el.set_min(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::max(
        ...
        attr_name = "max",
        csr {
            update: |el: &web_sys::HtmlMeterElement, _, &v: &_| el.set_max(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::low(
        bounds as crate::imports::impl_bounds::MaybeValue<f64>,
        element as web_sys::HtmlMeterElement,
        attr_name = "low",
        csr {
            update: |el: &web_sys::HtmlMeterElement, _, &v: &_| el.set_low(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::high(
        bounds as crate::imports::impl_bounds::MaybeValue<f64>,
        element as web_sys::HtmlMeterElement,
        attr_name = "high",
        csr {
            update: |el: &web_sys::HtmlMeterElement, _, &v: &_| el.set_high(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
    crate::imports::impl_bounds!(super::props::optimum(
        bounds as crate::imports::impl_bounds::MaybeValue<f64>,
        element as web_sys::HtmlMeterElement,
        attr_name = "optimum",
        csr {
            update: |el: &web_sys::HtmlMeterElement, _, &v: &_| el.set_optimum(v),
            remove: crate::imports::impl_bounds::MaybeValue::csr::default_remove,
        },
    ));
}
