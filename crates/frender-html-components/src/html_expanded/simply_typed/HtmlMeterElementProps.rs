def_props_type!(
    ...
    HtmlMeterElementProps[..HtmlElementProps[..ElementProps[children, class :
    ...
    on_drop,], value : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < f64 >], min :
    bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < f64 >], max
    : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < f64 >],
    low : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState < f64
    >], high : bounds![crate ::imports::frender_html::props::MaybeUpdateValueWithState <
    f64 >], optimum : bounds![crate
    ::imports::frender_html::props::MaybeUpdateValueWithState < f64 >],]
);
#[cfg(feature = "dom")]
