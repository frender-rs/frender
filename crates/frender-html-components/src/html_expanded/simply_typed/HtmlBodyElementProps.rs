...
#[inline(always)]
pub fn HtmlBodyElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlBodyElementProps<
...
pub use building_struct::HtmlBodyElementProps as Building;
pub use data_struct::HtmlBodyElementProps as Data;
pub type DataInitial = data_struct::HtmlBodyElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlBodyElement>,
        > crate::imports::frender_dom::props::UpdateElementNonReactive<E>
        for super::props::alink<V>
    {
        type State = super::props::alink<V::State>;
...
mod builder_and_replacer {
    ...
    impl<Children, Props> super::Building<Children, Props> {
        ...
        pub fn alink<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            alink: V,
        ) -> super::Building<Children, (Props, super::props::alink<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::props::alink(alink)),
            })
        }
    }
}
