...
#[inline(always)]
pub fn HtmlLiElementProps() -> Building {
...
pub use building_struct::HtmlLiElementProps as Building;
pub use data_struct::HtmlLiElementProps as Data;
pub type DataInitial = data_struct::HtmlLiElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlLiElement>,
