...
#[inline(always)]
pub fn HtmlDataElementProps() -> Building {
...
pub mod data_struct {
    ...
    #[repr(transparent)]
    pub struct HtmlDataElementProps<
...
pub use building_struct::HtmlDataElementProps as Building;
pub use data_struct::HtmlDataElementProps as Data;
pub type DataInitial = data_struct::HtmlDataElementProps;
pub mod prelude {}
#[inline(always)]
...
mod props_impl_dom {
    ...
    impl<
            ...
            E: ::core::convert::AsRef<web_sys::HtmlDataElement>,
