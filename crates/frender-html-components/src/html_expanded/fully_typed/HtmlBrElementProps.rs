...
mod trait_types {
    ...
    pub trait Types {
        ...
        type clear: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>;
    }
}
...
pub use data_struct::HtmlBrElementProps as Building;
...
pub mod render_state {
    ...
    crate::imports::pin_project! {
        ...
        TypeDefs::HtmlElementProps, pub clear : TypeDefs::clear, }
    }
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[deprecated]
        #[inline(always)]
        pub fn clear<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            clear: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::frender_csr::props::UpdateElement<HtmlBrElement> for super::Data<TypeDefs>
    where
            ...
            crate::imports::frender_csr::props::UpdateElement<HtmlElement>,
    {
        type State = super::render_state::RenderState<
            dyn super::render_state::RenderStateTypes<
                ...
                > as crate::imports::frender_csr::props::UpdateElement<
                    HtmlElement,
                >>::State,
                clear = <TypeDefs::clear as ::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
            >,
        >;
        fn initialize_state(
            ...
            super::render_state::RenderState {
                ...
                clear: <TypeDefs::clear as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                    str,
        ...
        fn update_element(
            ...
            <TypeDefs::clear as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                str,
        ...
        fn into_ssr_data(this: Self) -> (Self::Children, Self::Attrs) {
            ...
            (
                ...
                attrs.chain(::frender_ssr::utils::filter::FilterIdentity(
                    [
                        <TypeDefs::clear as ::frender_html::props::MaybeUpdateValueWithState<
                            str,
                        >>::maybe_into_html_attribute_value(this.clear)
                        .map(|value| {
                            (
