...
pub use data_struct::HtmlTableElementProps as Building;
...
pub mod render_state {
    ...
    crate::imports::pin_project! {
        ...
        TypeDefs::bg_color, pub border : TypeDefs::border, pub cell_padding :
        TypeDefs::cell_padding, pub cell_spacing : TypeDefs::cell_spacing, pub frame :
        TypeDefs::frame, pub rules : TypeDefs::rules, pub summary : TypeDefs::summary,
        pub width : TypeDefs::width, }
    }
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::frender_csr::props::UpdateElement<web_sys::HtmlTableElement>
