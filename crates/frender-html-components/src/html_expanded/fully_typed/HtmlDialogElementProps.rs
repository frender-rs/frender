...
mod trait_types {
    ...
    pub trait Types {
        ...
        type open: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>;
    }
}
...
pub use data_struct::HtmlDialogElementProps as Building;
...
pub mod render_state {
    ...
    crate::imports::pin_project! {
        ...
        TypeDefs::HtmlElementProps, pub open : TypeDefs::open, }
    }
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn open<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<bool>>(
            self,
            open: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::frender_csr::props::UpdateElement<web_sys::HtmlDialogElement>
            ...
            crate::imports::frender_csr::props::UpdateElement<web_sys::HtmlElement>,
    {
        type State = super::render_state::RenderState<
            dyn super::render_state::RenderStateTypes<
                ...
                > as crate::imports::frender_csr::props::UpdateElement<
                    web_sys::HtmlElement,
                >>::State,
                open = <TypeDefs::open as ::frender_html::props::MaybeUpdateValueWithState<
                    bool,
                >>::State,
            >,
        >;
        fn initialize_state(
            ...
            super::render_state::RenderState {
                ...
                open: <TypeDefs::open as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                    bool,
        ...
        fn update_element(
            ...
            <TypeDefs::open as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                bool,
        ...
        fn into_ssr_data(this: Self) -> (Self::Children, Self::Attrs) {
            ...
            (
                ...
                attrs.chain(::frender_ssr::utils::filter::FilterIdentity(
                    [
                        <TypeDefs::open as ::frender_html::props::MaybeUpdateValueWithState<
                            bool,
                        >>::maybe_into_html_attribute_value(this.open)
                        .map(|value| {
                            (
