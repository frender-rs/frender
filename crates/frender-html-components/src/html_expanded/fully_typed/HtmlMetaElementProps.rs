...
pub mod overwrite {
    ...
    pub type HtmlElementProps<TypeDefs, Value> = dyn super::Types<
        ...
        charset = <TypeDefs as super::Types>::charset,
        content = <TypeDefs as super::Types>::content,
        http_equiv = <TypeDefs as super::Types>::http_equiv,
    ...
    pub type on_drop<TypeDefs, Value> = self::HtmlElementProps<
        ...
        >,
    >;
    pub type charset<TypeDefs, Value> = dyn super::Types<
        ...
        name = <TypeDefs as super::Types>::name,
    >;
    pub type content<TypeDefs, Value> = dyn super::Types<
        HtmlElementProps = <TypeDefs as super::Types>::HtmlElementProps,
        charset = <TypeDefs as super::Types>::charset,
        content = Value,
        http_equiv = <TypeDefs as super::Types>::http_equiv,
        name = <TypeDefs as super::Types>::name,
    >;
    pub type http_equiv<TypeDefs, Value> = dyn super::Types<
        HtmlElementProps = <TypeDefs as super::Types>::HtmlElementProps,
        charset = <TypeDefs as super::Types>::charset,
        content = <TypeDefs as super::Types>::content,
        http_equiv = Value,
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type charset: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>;
        type content: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>;
        type http_equiv: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>;
...
pub mod data_struct {
    #[non_exhaustive]
    pub struct HtmlMetaElementProps<TypeDefs: super::Types + ?::core::marker::Sized> {
        pub HtmlElementProps: super::super::HtmlElementProps::Data<TypeDefs::HtmlElementProps>,
        pub charset: TypeDefs::charset,
        pub content: TypeDefs::content,
        pub http_equiv: TypeDefs::http_equiv,
        pub name: TypeDefs::name,
    }
}
pub use ::core::convert::identity as Building;
pub use ::core::convert::identity as build;
pub use data_struct::HtmlMetaElementProps as Data;
pub use data_struct::HtmlMetaElementProps as Building;
...
pub mod render_state {
    ...
    crate::imports::pin_project! {
        ...
        TypeDefs::HtmlElementProps, pub charset : TypeDefs::charset, pub content :
        TypeDefs::content, pub http_equiv : TypeDefs::http_equiv, pub name :
        TypeDefs::name, }
    }
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn charset<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            charset: V,
        ) -> super::Building<super::overwrite::charset<TypeDefs, V>> {
            super::Data {
        ...
        #[inline(always)]
        pub fn content<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            content: V,
        ) -> super::Building<super::overwrite::content<TypeDefs, V>> {
            super::Data {
                HtmlElementProps: self.HtmlElementProps,
                charset: self.charset,
                content,
        ...
        >(
            self,
            http_equiv: V,
        ) -> super::Building<super::overwrite::http_equiv<TypeDefs, V>> {
            super::Data {
                HtmlElementProps: self.HtmlElementProps,
                charset: self.charset,
                content: self.content,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::frender_csr::props::UpdateElement<HtmlMetaElement> for super::Data<TypeDefs>
    where
            ...
            crate::imports::frender_csr::props::UpdateElement<HtmlElement>,
    {
        type State = super::render_state::RenderState<
            dyn super::render_state::RenderStateTypes<
                ...
                > as crate::imports::frender_csr::props::UpdateElement<
                    HtmlElement,
                >>::State,
                charset = <TypeDefs::charset as ::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
                content = <TypeDefs::content as ::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
                http_equiv = <TypeDefs::http_equiv as ::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
        ...
        fn initialize_state(
            ...
            super::render_state::RenderState {
                ...
                charset: <TypeDefs::charset as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::initialize_state_and_update(
                    ...
                    || dom_element.remove_attribute("charset").unwrap(),
                ),
                content: <TypeDefs::content as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::initialize_state_and_update(
                    this.content,
        ...
        fn update_element(
            ...
            <TypeDefs::charset as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                str,
            ...
            <TypeDefs::content as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                str,
            >>::maybe_update_value_with_state(
                this.content,
                state.content,
                ...
                attrs
                    .chain(
                        ::frender_ssr::utils::filter::FilterIdentity(
                            [
                                <TypeDefs::charset as ::frender_html::props::MaybeUpdateValueWithState<
                                    str,
                                >>::maybe_into_html_attribute_value(this.charset)
                                    .map(|value| (
                                        ::std::borrow::Cow::Borrowed("charset"),
                                ...
                                <TypeDefs::content as ::frender_html::props::MaybeUpdateValueWithState<
                                    str,
                                >>::maybe_into_html_attribute_value(this.content)
                                    .map(|value| (
                                ...
                                <TypeDefs::http_equiv as ::frender_html::props::MaybeUpdateValueWithState<
                                    str,
                                >>::maybe_into_html_attribute_value(this.http_equiv)
                                    .map(|value| (
                                        ::std::borrow::Cow::Borrowed("http-equiv"),
                                        if let Some(value) = value {
                                            ::frender_ssr::element::html::HtmlAttributeValue::String(
                                                value,
                                            )
