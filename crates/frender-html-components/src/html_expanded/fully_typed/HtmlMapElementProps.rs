...
pub use data_struct::HtmlMapElementProps as Building;
...
pub mod render_state {
    ...
    crate::imports::pin_project! {
        ...
        TypeDefs::HtmlElementProps, pub name : TypeDefs::name, }
    }
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::frender_csr::props::UpdateElement<HtmlMapElement> for super::Data<TypeDefs>
    where
