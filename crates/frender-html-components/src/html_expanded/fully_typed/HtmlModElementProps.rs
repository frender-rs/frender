...
mod trait_types {
    ...
    pub trait Types {
        ...
        type cite: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>;
        type date_time: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>;
    }
}
...
pub use data_struct::HtmlModElementProps as Building;
...
pub mod render_state {
    ...
    crate::imports::pin_project! {
        ...
        TypeDefs::HtmlElementProps, pub cite : TypeDefs::cite, pub date_time :
        TypeDefs::date_time, }
    }
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn cite<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            cite: V,
        ) -> super::Building<super::overwrite::cite<TypeDefs, V>> {
            super::Data {
        ...
        #[inline(always)]
        pub fn date_time<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<str>>(
            self,
            date_time: V,
        ) -> super::Building<super::overwrite::date_time<TypeDefs, V>> {
            super::Data {
                HtmlElementProps: self.HtmlElementProps,
                cite: self.cite,
                date_time,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::frender_csr::props::UpdateElement<HtmlModElement> for super::Data<TypeDefs>
    where
            ...
            crate::imports::frender_csr::props::UpdateElement<HtmlElement>,
    {
        type State = super::render_state::RenderState<
            dyn super::render_state::RenderStateTypes<
                ...
                > as crate::imports::frender_csr::props::UpdateElement<
                    HtmlElement,
                >>::State,
                cite = <TypeDefs::cite as ::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
                date_time = <TypeDefs::date_time as ::frender_html::props::MaybeUpdateValueWithState<
                    str,
                >>::State,
            >,
        >;
        fn initialize_state(
            ...
            super::render_state::RenderState {
                ...
                cite: <TypeDefs::cite as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                    str,
        ...
        fn update_element(
            ...
            <TypeDefs::cite as crate::imports::frender_html::props::MaybeUpdateValueWithState<
                str,
                ...
                attrs
                    .chain(
                        ::frender_ssr::utils::filter::FilterIdentity(
                            [
                                <TypeDefs::cite as ::frender_html::props::MaybeUpdateValueWithState<
                                    str,
                                >>::maybe_into_html_attribute_value(this.cite)
                                    .map(|value| (
                                        ::std::borrow::Cow::Borrowed("cite"),
                                ...
                                <TypeDefs::date_time as ::frender_html::props::MaybeUpdateValueWithState<
                                    str,
                                >>::maybe_into_html_attribute_value(this.date_time)
                                    .map(|value| (
