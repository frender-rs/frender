...
mod trait_types {
    ...
    pub trait Types {
        ...
        type value: crate::imports::frender_html::props::MaybeUpdateValueWithState<i32>;
    }
}
...
pub use data_struct::HtmlLiElementProps as Building;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub fn value<V: crate::imports::frender_html::props::MaybeUpdateValueWithState<i32>>(
            self,
            value: V,
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::imports::frender_csr::props::UpdateElement<HtmlLiElement> for super::Data<TypeDefs>
    where
