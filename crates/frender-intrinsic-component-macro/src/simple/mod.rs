            ...
            #vis mod #name {
                ...
                mod impl_update_element {
                    ...
                    impl<
                        ...
                        Children,
                        Props,
                    > #crate_path::frender_dom::props::UpdateElement<E> for super::Data<Children, Props>
                    where
                        #crate_path::frender_html_simple::ElementProps<Children, Props>:
                            #crate_path::frender_dom::props::UpdateElement<E>
                    {
                        type State = <
                            #crate_path::frender_html_simple::ElementProps<Children, Props>
                            as
                        ...
                        #[inline(always)]
                        fn initialize_state(this: Self, element: &E, children_ctx: &mut ::frender_dom::Dom) -> Self::State {
                            #crate_path::frender_html_simple::ElementProps::<Children, Props>::initialize_state(
                                this.props,
                                element,
                                children_ctx,
                            )
                        ...
                        #[inline(always)]
                        fn update_element(this: Self, element: &E, children_ctx: &mut ::frender_dom::Dom, state: ::core::pin::Pin<&mut Self::State>) {
                            #crate_path::frender_html_simple::ElementProps::<Children, Props>::update_element(
                                this.props,
                                element,
                                children_ctx,
                                state,
                ...
                mod impl_into_ssr_data {
                    ...
                    impl<
                        ...
                        Children,
                        Props,
                    > #crate_path::frender_ssr::IntoSsrData<W> for super::Data<Children, Props>
                    where
                        #crate_path::frender_html_simple::ElementProps<Children, Props>:
                            #crate_path::frender_ssr::IntoSsrData<W>
                    {
                        type Children = <
                            #crate_path::frender_html_simple::ElementProps<Children, Props>
                            as
                        ...
                        fn into_ssr_data(this: Self) -> (Self::Children, Self::Attrs) {
                            #crate_path::frender_ssr::IntoSsrData::<W>::into_ssr_data(this.props)
                        }
                    }
                }
