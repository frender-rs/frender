...
mod trait_types {
    ...
    pub trait Types {
        ...
        type span: crate::MaybeUpdateValue<u32>;
...
pub mod render_state {
    ...
    pub trait RenderStateTypes {
        ...
        type span: ::core::default::Default;
        ...
        TypeDefs: ?::core::marker::Sized,
    {
        ...
        pub span: &'__pin mut (TypeDefs::span),
    ...
    const _: () = {
            ...
            TypeDefs: ?::core::marker::Sized,
        {
            ...
            span: ::pin_project_lite::__private::AlwaysUnpin<TypeDefs::span>,
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        pub fn span<V: crate::MaybeUpdateValue<u32>>(
            self,
            span: V,
...
mod impl_update_element {
    ...
    {
        type State = super :: render_state :: RenderState < dyn super :: render_state :: RenderStateTypes < HtmlElementProps = < HtmlElementProps :: Data < TypeDefs :: HtmlElementProps , > as crate :: props :: UpdateElement < web_sys :: HtmlElement > > :: State , align = < TypeDefs :: align as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , bg_color = < TypeDefs :: bg_color as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , char = < TypeDefs :: char as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , char_off = < TypeDefs :: char_off as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , v_align = < TypeDefs :: v_align as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , span = < TypeDefs :: span as :: frender_dom :: props :: MaybeUpdateValue < u32 , > > :: State , width = < TypeDefs :: width as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , > , > ;
        fn update_element(
            this: Self,
            ...
            match (crate::props::FieldData {
                ...
                crate::props::FieldData {
                    ...
                    < TypeDefs :: span as :: frender_dom :: props :: MaybeUpdateValue < u32 , > > :: maybe_update_value (data , state , | v | element . set_span (* v) , | | dom_element . remove_attribute (ATTR_NAME) . unwrap () ,)
                }
            }
            #[allow(unused_variables)]
            match (crate::props::FieldData {
