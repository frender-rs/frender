...
#[inline(always)]
pub const fn HtmlTableColElementProps() -> Building<TypesInitial> {
...
pub mod overwrite {
    ...
    pub type HtmlElementProps<TypeDefs, Value> = dyn super::Types<
        ...
        span = <TypeDefs as super::Types>::span,
    ...
    pub type v_align<TypeDefs, Value> = dyn super::Types<
        ...
        width = <TypeDefs as super::Types>::width,
    >;
    pub type span<TypeDefs, Value> = dyn super::Types<
        HtmlElementProps = <TypeDefs as super::Types>::HtmlElementProps,
        align = <TypeDefs as super::Types>::align,
        bg_color = <TypeDefs as super::Types>::bg_color,
        char = <TypeDefs as super::Types>::char,
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type span: crate::MaybeUpdateValue<u32> + ~const ::core::marker::Destruct;
...
pub mod data_struct {
    #[non_exhaustive]
    pub struct HtmlTableColElementProps<TypeDefs: super::Types + ?::core::marker::Sized> {
        ...
        pub span: TypeDefs::span,
        pub width: TypeDefs::width,
    }
}
pub use data_struct::HtmlTableColElementProps as Data;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn span<V: crate::MaybeUpdateValue<u32>>(
            self,
            span: V,
        ) -> super::Building<super::overwrite::span<TypeDefs, V>>
        where
            Self: ~const ::core::marker::Destruct,
        {
            super::Building(super::Data {
...
mod impl_update_element {
    ...
    impl<TypeDefs: ?::core::marker::Sized + super::Types>
        crate::props::UpdateElement<web_sys::HtmlTableColElement> for super::Data<TypeDefs>
    where
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn initialize_state(
            ...
            <TypeDefs::span as ::frender_dom::props::MaybeUpdateValue<u32>>::maybe_update_value(
                ...
                || dom_element.remove_attribute("span").unwrap(),
            );
