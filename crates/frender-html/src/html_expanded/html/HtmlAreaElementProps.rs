...
#[inline(always)]
pub const fn HtmlAreaElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type coords: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type shape: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn coords<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            coords: V,
        ...
        #[inline(always)]
        pub const fn shape<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            shape: V,
