...
#[inline(always)]
pub const fn HtmlMeterElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type value: crate::MaybeUpdateValue<f64> + ~const ::core::marker::Destruct;
        type min: crate::MaybeUpdateValue<f64> + ~const ::core::marker::Destruct;
        type max: crate::MaybeUpdateValue<f64> + ~const ::core::marker::Destruct;
        type low: crate::MaybeUpdateValue<f64> + ~const ::core::marker::Destruct;
        type high: crate::MaybeUpdateValue<f64> + ~const ::core::marker::Destruct;
        type optimum: crate::MaybeUpdateValue<f64> + ~const ::core::marker::Destruct;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn value<V: crate::MaybeUpdateValue<f64>>(
            self,
            value: V,
        ...
        #[inline(always)]
        pub const fn min<V: crate::MaybeUpdateValue<f64>>(
            self,
            min: V,
        ...
        #[inline(always)]
        pub const fn max<V: crate::MaybeUpdateValue<f64>>(
            self,
            max: V,
        ...
        #[inline(always)]
        pub const fn low<V: crate::MaybeUpdateValue<f64>>(
            self,
            low: V,
        ...
        #[inline(always)]
        pub const fn high<V: crate::MaybeUpdateValue<f64>>(
            self,
            high: V,
        ...
        #[inline(always)]
        pub const fn optimum<V: crate::MaybeUpdateValue<f64>>(
            self,
            optimum: V,
