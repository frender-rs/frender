...
#[inline(always)]
pub const fn HtmlImageElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type alt: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type cross_origin: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type decoding: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type element_timing: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type height: crate::MaybeUpdateValue<u32> + ~const ::core::marker::Destruct;
        type is_map: crate::MaybeUpdateValue<bool> + ~const ::core::marker::Destruct;
        ...
        type srcset: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type width: crate::MaybeUpdateValue<u32> + ~const ::core::marker::Destruct;
        type use_map: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn alt<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            alt: V,
        ...
        #[inline(always)]
        pub const fn decoding<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            decoding: V,
        ...
        #[inline(always)]
        pub const fn element_timing<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            element_timing: V,
        ...
        #[inline(always)]
        pub const fn is_map<V: crate::MaybeUpdateValue<bool>>(
            self,
            is_map: V,
        ...
        #[inline(always)]
        pub const fn srcset<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            srcset: V,
        ...
        #[inline(always)]
        pub const fn use_map<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            use_map: V,
