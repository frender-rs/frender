...
#[inline(always)]
pub const fn HtmlDialogElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type open: crate::MaybeUpdateValue<bool> + ~const ::core::marker::Destruct;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn open<V: crate::MaybeUpdateValue<bool>>(
            self,
            open: V,
