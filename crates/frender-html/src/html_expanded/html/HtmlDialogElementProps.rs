...
mod trait_types {
    ...
    pub trait Types {
        ...
        type open: crate::MaybeUpdateValue<bool>;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        pub fn open<V: crate::MaybeUpdateValue<bool>>(
            self,
            open: V,
...
mod impl_update_element {
    ...
    {
        type State = super :: render_state :: RenderState < dyn super :: render_state :: RenderStateTypes < HtmlElementProps = < HtmlElementProps :: Data < TypeDefs :: HtmlElementProps , > as crate :: props :: UpdateElement < web_sys :: HtmlElement > > :: State , open = < TypeDefs :: open as :: frender_dom :: props :: MaybeUpdateValue < bool , > > :: State , > , > ;
        fn update_element(
            this: Self,
