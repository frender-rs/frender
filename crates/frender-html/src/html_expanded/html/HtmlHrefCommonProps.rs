...
pub fn HtmlHrefCommonProps() -> Building<TypesInitial> {
...
pub mod data_struct {
    #[non_exhaustive]
    pub struct HtmlHrefCommonProps<TypeDefs: super::Types + ?::core::marker::Sized> {
...
pub use data_struct::HtmlHrefCommonProps as Data;
