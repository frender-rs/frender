...
#[inline(always)]
pub const fn HtmlObjectElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type data: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn data<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            data: V,
...
mod impl_update_element {
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn initialize_state(
            ...
            < TypeDefs :: data as :: frender_dom :: props :: MaybeUpdateValueByRef < str , > > :: maybe_update_value_by_ref (& this . data , | v | element . set_data (v) , | | dom_element . remove_attribute ("data") . unwrap () ,) ;
