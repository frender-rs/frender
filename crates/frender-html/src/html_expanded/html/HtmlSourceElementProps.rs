        ...
        fn update_element(
            ...
            match (crate::props::FieldData {
                ...
                crate::props::FieldData {
                    ...
                    < TypeDefs :: width as :: frender_dom :: props :: MaybeUpdateValue < u32 , > > :: maybe_update_value (data , state , | v | crate :: props :: UpdateElementAttribute :: update_element_attribute (v , dom_element , ATTR_NAME ,) , | | dom_element . remove_attribute (ATTR_NAME) . unwrap () ,)
                }
            }
        }
    }
