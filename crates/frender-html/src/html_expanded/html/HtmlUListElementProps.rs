...
#[inline(always)]
pub const fn HtmlUListElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type compact: crate::MaybeUpdateValue<bool> + ~const ::core::marker::Destruct;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn compact<V: crate::MaybeUpdateValue<bool>>(
            self,
            compact: V,
...
mod impl_update_element {
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn initialize_state(
            ...
            <TypeDefs::compact as ::frender_dom::props::MaybeUpdateValue<bool>>::maybe_update_value(
                this.compact,
