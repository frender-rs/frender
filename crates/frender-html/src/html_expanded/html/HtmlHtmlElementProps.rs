...
pub mod overwrite {
    ...
    pub type HtmlElementProps<TypeDefs, Value> =
        dyn super::Types<HtmlElementProps = Value, xmlns = <TypeDefs as super::Types>::xmlns>;
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type xmlns: crate::MaybeUpdateValue<str>;
    }
}
...
mod types_initial {
    ...
    pub type TypesInitial =
        dyn super::Types<HtmlElementProps = HtmlElementProps::TypesInitial, xmlns = ()>;
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        pub fn xmlns<V: crate::MaybeUpdateValue<str>>(
            self,
            xmlns: V,
        ) -> super::Building<super::overwrite::xmlns<TypeDefs, V>> {
            super::Building(super::Data {
...
mod impl_update_element {
    ...
    {
        type State = super :: render_state :: RenderState < dyn super :: render_state :: RenderStateTypes < HtmlElementProps = < HtmlElementProps :: Data < TypeDefs :: HtmlElementProps , > as crate :: props :: UpdateElement < web_sys :: HtmlElement > > :: State , xmlns = < TypeDefs :: xmlns as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , > , > ;
        fn update_element(
            this: Self,
