...
#[inline(always)]
pub const fn HtmlOptionElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type label: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type selected: crate::MaybeUpdateValue<bool> + ~const ::core::marker::Destruct;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn label<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            label: V,
        ...
        #[inline(always)]
        pub const fn selected<V: crate::MaybeUpdateValue<bool>>(
            self,
            selected: V,
...
mod impl_update_element {
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn initialize_state(
            ...
            < TypeDefs :: selected as :: frender_dom :: props :: MaybeUpdateValue < bool , > > :: maybe_update_value (this . selected , | v | element . set_selected (v) , | | dom_element . remove_attribute ("selected") . unwrap () ,) ;
