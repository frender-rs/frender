...
mod trait_types {
    ...
    pub trait Types {
        ...
        type label: crate::MaybeUpdateValueByRef<str>;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline]
        pub fn label<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            label: V,
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn update_element(
            ...
            }
            {
                ...
                < TypeDefs :: selected as :: frender_dom :: props :: MaybeUpdateValue < bool , > > :: maybe_update_value (this . selected , | v | element . set_selected (v) , | | dom_element . remove_attribute (ATTR_NAME) . unwrap () ,)
            }
            {
                #[allow(unused)]
