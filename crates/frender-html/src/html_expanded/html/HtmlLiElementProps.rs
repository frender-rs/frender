...
#[inline(always)]
pub const fn HtmlLiElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type value: crate::MaybeUpdateValue<i32> + ~const ::core::marker::Destruct;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn value<V: crate::MaybeUpdateValue<i32>>(
            self,
            value: V,
