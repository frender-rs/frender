...
mod trait_types {
    ...
    pub trait Types {
        ...
        type charset: crate::MaybeUpdateValue<str>;
        type content: crate::MaybeUpdateValue<str>;
        type http_equiv: crate::MaybeUpdateValue<str>;
...
pub mod render_state {
    ...
    pub trait RenderStateTypes {
        ...
        type charset: ::core::default::Default;
        type content: ::core::default::Default;
        type http_equiv: ::core::default::Default;
        ...
        for RenderState<TypeDefs>
    {
        fn default() -> Self {
            Self {
                ...
                http_equiv: ::core::default::Default::default(),
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline]
        pub fn charset<V: crate::MaybeUpdateValue<str>>(
            self,
            charset: V,
        ...
        #[inline]
        pub fn content<V: crate::MaybeUpdateValue<str>>(
            self,
            content: V,
        ...
        #[inline]
        pub fn http_equiv<V: crate::MaybeUpdateValue<str>>(
            self,
            http_equiv: V,
...
mod impl_update_element {
    ...
    {
        type State = super :: render_state :: RenderState < dyn super :: render_state :: RenderStateTypes < HtmlElementProps = < HtmlElementProps :: Data < TypeDefs :: HtmlElementProps , > as crate :: props :: UpdateElement < web_sys :: HtmlElement > > :: State , charset = < TypeDefs :: charset as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , content = < TypeDefs :: content as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , http_equiv = < TypeDefs :: http_equiv as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , name = < TypeDefs :: name as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , > , > ;
        fn update_element(
            this: Self,
