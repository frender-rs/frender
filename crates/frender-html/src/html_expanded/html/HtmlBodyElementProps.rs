...
mod trait_types {
    ...
    pub trait Types {
        ...
        type alink: crate::MaybeUpdateValue<str>;
    }
}
...
pub mod render_state {
    ...
    pub trait RenderStateTypes {
        ...
        type alink: ::core::default::Default;
    }
        ...
        TypeDefs: ?::core::marker::Sized,
    {
        ...
        pub alink: &'__pin mut (TypeDefs::alink),
    }
    ...
    const _: () = {
            ...
            TypeDefs: ?::core::marker::Sized,
        {
            ...
            pub alink: &'__pin (TypeDefs::alink),
        }
            ...
            TypeDefs: ?::core::marker::Sized,
        {
            ...
            alink: ::pin_project_lite::__private::AlwaysUnpin<TypeDefs::alink>,
        }
        ...
        for RenderState<TypeDefs>
    {
        fn default() -> Self {
            Self {
                ...
                alink: ::core::default::Default::default(),
            }
        }
    }
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        pub fn alink<V: crate::MaybeUpdateValue<str>>(
            self,
            alink: V,
...
mod impl_update_element {
    ...
    {
        type State = super :: render_state :: RenderState < dyn super :: render_state :: RenderStateTypes < HtmlElementProps = < HtmlElementProps :: Data < TypeDefs :: HtmlElementProps , > as crate :: props :: UpdateElement < web_sys :: HtmlElement > > :: State , alink = < TypeDefs :: alink as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , > , > ;
        fn update_element(
            this: Self,
            ...
            match (crate::props::FieldData {
                ...
                crate::props::FieldData {
                    ...
                    #[allow(unused)]
                    const ATTR_NAME: &::core::primitive::str = "alink";
                    < TypeDefs :: alink as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: maybe_update_value (data , state , | v | crate :: props :: UpdateElementAttribute :: update_element_attribute (v , dom_element , ATTR_NAME ,) , | | dom_element . remove_attribute (ATTR_NAME) . unwrap () ,)
                }
            }
        }
    }
