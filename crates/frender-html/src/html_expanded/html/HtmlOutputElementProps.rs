...
#[inline(always)]
pub const fn HtmlOutputElementProps() -> Building<TypesInitial> {
...
mod impl_update_element {
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn initialize_state(
            ...
            < TypeDefs :: html_for as :: frender_dom :: props :: MaybeUpdateValueByRef < str , > > :: maybe_update_value_by_ref (& this . html_for , | v | crate :: props :: UpdateElementAttribute :: update_element_attribute (v , dom_element , "for" ,) , | | dom_element . remove_attribute ("for") . unwrap () ,) ;
