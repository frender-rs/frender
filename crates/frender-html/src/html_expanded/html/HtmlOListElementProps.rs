...
#[inline(always)]
pub const fn HtmlOListElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type reversed: crate::MaybeUpdateValue<bool> + ~const ::core::marker::Destruct;
        type start: crate::MaybeUpdateValue<i32> + ~const ::core::marker::Destruct;
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn reversed<V: crate::MaybeUpdateValue<bool>>(
            self,
            reversed: V,
        ...
        #[inline(always)]
        pub const fn start<V: crate::MaybeUpdateValue<i32>>(
            self,
            start: V,
...
mod impl_update_element {
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn initialize_state(
            ...
            < TypeDefs :: reversed as :: frender_dom :: props :: MaybeUpdateValue < bool , > > :: maybe_update_value (this . reversed , | v | element . set_reversed (v) , | | dom_element . remove_attribute ("reversed") . unwrap () ,) ;
