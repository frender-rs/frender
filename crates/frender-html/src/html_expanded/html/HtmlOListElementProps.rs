            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn update_element(
            ...
            );
            {
                ...
                < TypeDefs :: reversed as :: frender_dom :: props :: MaybeUpdateValue < bool , > > :: maybe_update_value (this . reversed , | v | element . set_reversed (v) , | | dom_element . remove_attribute (ATTR_NAME) . unwrap () ,)
            }
            {
                #[allow(unused)]
