...
mod trait_types {
    ...
    pub trait Types {
        ...
        type reversed: crate::MaybeUpdateValue<bool>;
        type start: crate::MaybeUpdateValue<i32>;
...
pub mod render_state {
    ...
    pub trait RenderStateTypes {
        ...
        type reversed: ::core::default::Default;
        type start: ::core::default::Default;
        ...
        for RenderState<TypeDefs>
    {
        fn default() -> Self {
            Self {
                ...
                reversed: ::core::default::Default::default(),
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline]
        pub fn reversed<V: crate::MaybeUpdateValue<bool>>(
            self,
            reversed: V,
        ...
        #[inline]
        pub fn start<V: crate::MaybeUpdateValue<i32>>(
            self,
            start: V,
        ...
        fn update_element(
            ...
            match (crate::props::FieldData {
                ...
                crate::props::FieldData {
                    ...
                    < TypeDefs :: start as :: frender_dom :: props :: MaybeUpdateValue < i32 , > > :: maybe_update_value (data , state , | v | element . set_start (* v) , | | dom_element . remove_attribute (ATTR_NAME) . unwrap () ,)
                }
            }
            #[allow(unused_variables)]
            match (crate::props::FieldData {
