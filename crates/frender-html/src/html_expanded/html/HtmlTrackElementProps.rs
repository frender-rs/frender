...
#[inline(always)]
pub const fn HtmlTrackElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type default: crate::MaybeUpdateValue<bool> + ~const ::core::marker::Destruct;
        type kind: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        ...
        type src_lang: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn default<V: crate::MaybeUpdateValue<bool>>(
            self,
            default: V,
        ...
        #[inline(always)]
        pub const fn kind<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            kind: V,
        ...
        #[inline(always)]
        pub const fn src_lang<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            src_lang: V,
