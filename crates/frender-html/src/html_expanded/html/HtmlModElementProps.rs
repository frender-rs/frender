...
mod trait_types {
    ...
    pub trait Types {
        ...
        type date_time: crate::MaybeUpdateValue<str>;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        pub fn date_time<V: crate::MaybeUpdateValue<str>>(
            self,
            date_time: V,
...
mod impl_update_element {
    ...
    {
        type State = super :: render_state :: RenderState < dyn super :: render_state :: RenderStateTypes < HtmlElementProps = < HtmlElementProps :: Data < TypeDefs :: HtmlElementProps , > as crate :: props :: UpdateElement < web_sys :: HtmlElement > > :: State , cite = < TypeDefs :: cite as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , date_time = < TypeDefs :: date_time as :: frender_dom :: props :: MaybeUpdateValue < str , > > :: State , > , > ;
        fn update_element(
            this: Self,
