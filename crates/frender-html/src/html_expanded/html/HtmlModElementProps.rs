...
#[inline(always)]
pub const fn HtmlModElementProps() -> Building<TypesInitial> {
...
mod trait_types {
    ...
    pub trait Types {
        ...
        type cite: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
        type date_time: crate::MaybeUpdateValueByRef<str> + ~const ::core::marker::Destruct;
    }
}
...
mod builder_and_replacer {
    ...
    impl<TypeDefs: super::Types + ?::core::marker::Sized> super::Building<TypeDefs> {
        ...
        #[inline(always)]
        pub const fn cite<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            cite: V,
        ...
        #[inline(always)]
        pub const fn date_time<V: crate::MaybeUpdateValueByRef<str>>(
            self,
            date_time: V,
...
mod impl_update_element {
            ...
            crate::props::UpdateElement<web_sys::HtmlElement>,
    {
        ...
        fn initialize_state(
            ...
            < TypeDefs :: cite as :: frender_dom :: props :: MaybeUpdateValueByRef < str , > > :: maybe_update_value_by_ref (& this . cite , | v | element . set_cite (v) , | | dom_element . remove_attribute ("cite") . unwrap () ,) ;
            < TypeDefs :: date_time as :: frender_dom :: props :: MaybeUpdateValueByRef < str , > > :: maybe_update_value_by_ref (& this . date_time , | v | element . set_date_time (v) , | | dom_element . remove_attribute ("datetime") . unwrap () ,) ;
            <HtmlElementProps::Data<TypeDefs::HtmlElementProps> as crate::props::UpdateElement<
                web_sys::HtmlElement,
