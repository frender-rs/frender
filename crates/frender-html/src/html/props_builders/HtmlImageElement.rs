use super::super::props::HtmlImageElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn decoding<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::decoding<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::decoding(value)),
            })
        }
        pub fn element_timing<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::element_timing<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::element_timing(value)),
            })
        }
        pub fn is_map<V: crate::impl_bounds::MaybeValue::Bounds<bool>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::is_map<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::is_map(value)),
            })
        }
        ...
        pub fn srcset<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::srcset<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::srcset(value)),
            })
        }
        pub fn use_map<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::use_map<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::use_map(value)),
            })
        }
