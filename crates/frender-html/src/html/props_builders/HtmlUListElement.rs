use super::super::props::HtmlUListElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        ...
        pub fn compact<V: crate::impl_bounds::MaybeValue::Bounds<bool>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::compact<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::compact(value)),
            })
        }
