use super::super::props::HtmlMetaElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn charset<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::charset<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::charset(value)),
            })
        }
        pub fn content<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::content<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::content(value)),
            })
        }
        pub fn http_equiv<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::http_equiv<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::http_equiv(value)),
            })
        }
