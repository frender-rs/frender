use super::super::props::HtmlMeterElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn min<V: crate::impl_bounds::MaybeValue::Bounds<f64>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::min<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::min(value)),
            })
        }
        pub fn low<V: crate::impl_bounds::MaybeValue::Bounds<f64>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::low<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::low(value)),
            })
        }
        pub fn high<V: crate::impl_bounds::MaybeValue::Bounds<f64>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::high<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::high(value)),
            })
        }
        pub fn optimum<V: crate::impl_bounds::MaybeValue::Bounds<f64>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::optimum<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::optimum(value)),
            })
        }
        ...
        pub fn max<V: crate::impl_bounds::MaybeValue::Bounds<f64>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::max<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::max(value)),
            })
        }
        pub fn value<V: crate::impl_bounds::MaybeValue::Bounds<f64>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::value<V>)> {
            super::Building(super::Data {
