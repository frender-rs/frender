use super::super::props::HtmlTableColElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn span<V: crate::impl_bounds::MaybeValue::Bounds<u32>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::span<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::span(value)),
            })
        }
        #[deprecated]
