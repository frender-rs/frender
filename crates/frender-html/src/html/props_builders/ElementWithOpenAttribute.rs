use super::super::props::ElementWithOpenAttribute::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn open<V: crate::impl_bounds::MaybeValue::Bounds<bool>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::open<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::open(value)),
            })
        }
