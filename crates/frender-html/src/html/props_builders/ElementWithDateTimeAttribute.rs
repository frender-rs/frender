use super::super::props::ElementWithDateTimeAttribute::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn date_time<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::date_time<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::date_time(value)),
            })
        }
