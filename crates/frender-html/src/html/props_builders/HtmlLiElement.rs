use super::super::props::HtmlLiElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn value<V: crate::impl_bounds::MaybeValue::Bounds<i32>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::value<V>)> {
