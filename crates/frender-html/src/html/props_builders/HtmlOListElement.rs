use super::super::props::HtmlOListElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn reversed<V: crate::impl_bounds::MaybeValue::Bounds<bool>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::reversed<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::reversed(value)),
            })
        }
        pub fn start<V: crate::impl_bounds::MaybeValue::Bounds<i32>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::start<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::start(value)),
            })
        }
