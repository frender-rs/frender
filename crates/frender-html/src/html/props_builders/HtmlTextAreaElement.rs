use super::super::props::HtmlTextAreaElement::*;
mod props_builder {
    ...
    impl<Children, Attrs> super::Building<Children, Attrs> {
        pub fn auto_correct<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::auto_correct<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::auto_correct(value)),
            })
        }
        pub fn cols<V: crate::impl_bounds::MaybeValue::Bounds<u32>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::cols<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::cols(value)),
            })
        }
        pub fn rows<V: crate::impl_bounds::MaybeValue::Bounds<u32>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::rows<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::rows(value)),
            })
        }
        pub fn wrap<V: crate::impl_bounds::MaybeValue::Bounds<str>>(self, value: V) -> super::Building<Children, (Attrs, super::attributes::wrap<V>)> {
            super::Building(super::Data {
                props: self.0.props.chain_prop(super::attributes::wrap(value)),
            })
        }
